...
// Type: pdfconverter.Controls.PPTToPDFUserControl
...
public partial class PPTToPDFUserControl : UserControl, IComponentConnector
{
  ...
  public PPTToPDFUserControl()
  {
    ...
    this.DataContext = (object) Ioc.Default.GetRequiredService<PPTToPDFUCViewModel>();
  }
  ...
  private void lsvFiles_Drop(object sender, DragEventArgs e)
  {
    if (e.Data.GetDataPresent(DataFormats.FileDrop))
    {
      ...
      PPTToPDFUCViewModel dataContext = this.DataContext as PPTToPDFUCViewModel;
  ...
  public void InitializeComponent()
  {
    ...
    Application.LoadComponent((object) this, new Uri("/pdfconverter;component/controls/ppttopdfusercontrol.xaml", UriKind.Relative));
  }
