...
// Type: pdfconverter.Controls.RTFToPDFUserControl
...
public partial class RTFToPDFUserControl : UserControl, IComponentConnector
{
  ...
  public RTFToPDFUserControl()
  {
    ...
    this.DataContext = (object) Ioc.Default.GetRequiredService<RTFToPDFUCViewModel>();
  }
  ...
  private void lsvFiles_Drop(object sender, DragEventArgs e)
  {
    if (e.Data.GetDataPresent(DataFormats.FileDrop))
    {
      ...
      RTFToPDFUCViewModel dataContext = this.DataContext as RTFToPDFUCViewModel;
  ...
  public void InitializeComponent()
  {
    ...
    Application.LoadComponent((object) this, new Uri("/pdfconverter;component/controls/rtftopdfusercontrol.xaml", UriKind.Relative));
  }
