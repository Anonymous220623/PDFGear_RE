...
// Type: pdfconverter.Controls.ImageToPDFUserControl
...
public partial class ImageToPDFUserControl : UserControl, IComponentConnector
{
  ...
  internal CheckBox cboxOutputInOneFile;
  ...
  public ImageToPDFUserControl()
  {
    ...
    this.DataContext = (object) Ioc.Default.GetRequiredService<ImageToPDFUCViewModel>();
  }
  ...
  private void lsvFiles_Drop(object sender, DragEventArgs e)
  {
    if (e.Data.GetDataPresent(DataFormats.FileDrop))
    {
      ...
      ImageToPDFUCViewModel dataContext = this.DataContext as ImageToPDFUCViewModel;
  ...
  public void InitializeComponent()
  {
    ...
    Application.LoadComponent((object) this, new Uri("/pdfconverter;component/controls/imagetopdfusercontrol.xaml", UriKind.Relative));
  }
  ...
  void IComponentConnector.Connect(int connectionId, object target)
  {
    switch (connectionId)
    {
      ...
      case 5:
        ...
        break;
      case 6:
        this.cboxOutputInOneFile = (CheckBox) target;
        break;
      case 7:
