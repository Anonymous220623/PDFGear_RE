...
// Type: pdfconverter.Controls.TXTToPDFUserControl
...
public partial class TXTToPDFUserControl : UserControl, IComponentConnector
{
  ...
  public TXTToPDFUserControl()
  {
    ...
    this.DataContext = (object) Ioc.Default.GetRequiredService<TXTToPDFUCViewModel>();
  }
  ...
  private void lsvFiles_Drop(object sender, DragEventArgs e)
  {
    if (e.Data.GetDataPresent(DataFormats.FileDrop))
    {
      ...
      TXTToPDFUCViewModel dataContext = this.DataContext as TXTToPDFUCViewModel;
  ...
  public void InitializeComponent()
  {
    ...
    Application.LoadComponent((object) this, new Uri("/pdfconverter;component/controls/txttopdfusercontrol.xaml", UriKind.Relative));
  }
