...
// Type: pdfconverter.Controls.WordToPDFUserControl
...
public partial class WordToPDFUserControl : UserControl, IComponentConnector
{
  ...
  public WordToPDFUserControl()
  {
    ...
    this.DataContext = (object) Ioc.Default.GetRequiredService<WordToPDFUCViewModel>();
  }
  ...
  private void lsvFiles_Drop(object sender, DragEventArgs e)
  {
    if (e.Data.GetDataPresent(DataFormats.FileDrop))
    {
      ...
      WordToPDFUCViewModel dataContext = this.DataContext as WordToPDFUCViewModel;
  ...
  public void InitializeComponent()
  {
    ...
    Application.LoadComponent((object) this, new Uri("/pdfconverter;component/controls/wordtopdfusercontrol.xaml", UriKind.Relative));
  }
