...
// Type: Syncfusion.ExcelToPdfConverter.ShapePath
...
internal class ShapePath
{
  ...
  {
    Dictionary<string, float> shapeFormula = this.ParseShapeFormula(AutoShapeType.CurvedConnector);
    GraphicsPath curvedConnectorPath = new GraphicsPath();
    PointF[] points = new PointF[7]
    {
      new PointF(this._rectBounds.X, this._rectBounds.Y),
      new PointF(this._rectBounds.X + shapeFormula["x1"], this._rectBounds.Y),
  ...
  internal PdfPath GetBentConnectorPath()
  {
    ...
    bentConnectorPath.AddLines(linePoints);
  ...
  internal GraphicsPath GetGDIBentConnectorPath()
  {
    ...
    GraphicsPath bentConnectorPath = new GraphicsPath();
    bentConnectorPath.AddLines(points);
    return bentConnectorPath;
  }
  ...
  internal PdfPath[] GetSmileyFacePath(bool isDrawEye)
  {
  ...
  {
    this.ParseShapeFormula(AutoShapeType.LightningBolt);
  ...
  {
    this.ParseShapeFormula(AutoShapeType.FlowChartAlternateProcess);
  ...
  internal PdfPath GetFlowChartOrPath()
  {
    ...
    this.ParseShapeFormula(AutoShapeType.FlowChartOr);
  ...
  {
    this.ParseShapeFormula(AutoShapeType.Explosion1);
  ...
  {
    this.ParseShapeFormula(AutoShapeType.Explosion2);
  ...
  {
    this.ParseShapeFormula(AutoShapeType.LineCallout2NoBorder);
  ...
  {
    this.ParseShapeFormula(AutoShapeType.LineCallout3NoBorder);
  ...
  {
    this.ParseShapeFormula(AutoShapeType.LineCallout1BorderAndAccentBar);
  ...
  {
    this.ParseShapeFormula(AutoShapeType.LineCallout2BorderAndAccentBar);
    PdfPath andAccentBarPath = new PdfPath();
    PointF[] linePoints = new PointF[2];
    andAccentBarPath.AddLines(linePoints);
    andAccentBarPath.CloseFigure();
  ...
  {
    this.ParseShapeFormula(AutoShapeType.LineCallout3BorderAndAccentBar);
    PdfPath andAccentBarPath = new PdfPath();
    PointF[] linePoints = new PointF[2];
    andAccentBarPath.AddLines(linePoints);
    andAccentBarPath.CloseFigure();
