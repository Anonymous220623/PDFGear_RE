...
// Type: Syncfusion.DocIO.DLS.Footnote
...
public class Footnote
{
  ...
  public Footnote(WordDocument document) => this.m_ownerDoc = document;

  internal Footnote(Footnote footnote)
  {
    this.m_separator = footnote.Separator.Clone() as WTextBody;
    this.m_continuationSeparator = footnote.ContinuationSeparator.Clone() as WTextBody;
    this.m_continuationNotice = footnote.ContinuationNotice.Clone() as WTextBody;
  }

  public Footnote Clone() => new Footnote(this);
