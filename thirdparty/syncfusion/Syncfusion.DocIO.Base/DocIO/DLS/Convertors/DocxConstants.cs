...
// Type: Syncfusion.DocIO.DLS.Convertors.DocxConstants
...
internal class DocxConstants
{
  ...
  internal const string DrawingPath = "word\\drawings\\";
  internal const string ThemePath = "word\\theme\\theme1.xml";
  internal const string FontsPath = "word\\fonts\\";
  ...
  internal const string VbaProjectSignature = "vbaProjectSignature.bin";
  internal const string VbaProjectSignatureAgile = "vbaProjectSignatureAgile.bin";
  internal const string VbaData = "vbaData.xml";
  internal const string VbaProjectPath = "word\\vbaProject.bin";
  internal const string VbaProjectSignaturePath = "word\\vbaProjectSignature.bin";
  internal const string VbaProjectSignatureAgilePath = "word\\vbaProjectSignatureAgile.bin";
  internal const string VbaDataPath = "word\\vbaData.xml";
  internal const string CustomXMLPath = "customXml\\";
  internal const string CommentsExtendedPath = "word\\commentsExtended.xml";
  internal const string GeneralRelationPath = "_rels\\.rels";
  internal const string WordRelationPath = "word\\_rels\\document.xml.rels";
  internal const string FontRelationPath = "word\\_rels\\fontTable.xml.rels";
  ...
  internal const string FontContentType = "application/vnd.openxmlformats-officedocument.obfuscatedFont";
  ...
  internal const string CommentsExtendedContentType = "application/vnd.openxmlformats-officedocument.wordprocessingml.commentsExtended+xml";
  ...
  internal const string VbaProjectSignatureContentType = "application/vnd.ms-office.vbaProjectSignature";
  internal const string VbaProjectSignatureAgileContentType = "application/vnd.ms-office.vbaProjectSignatureAgile";
  ...
  internal const string OleObjectContentType = "application/vnd.openxmlformats-officedocument.oleObject";
  ...
  internal const string CommentsExtendedRelType = "http://schemas.microsoft.com/office/2011/relationships/commentsExtended";
  internal const string SettingsRelType = "http://schemas.openxmlformats.org/officeDocument/2006/relationships/settings";
  internal const string SettingsRelType_Strict = "http://purl.oclc.org/ooxml/officeDocument/relationships/settings";
  ...
  internal const string FooterRelType_Strict = "http://purl.oclc.org/ooxml/officeDocument/relationships/footer";
  internal const string FootnoteRelType = "http://schemas.openxmlformats.org/officeDocument/2006/relationships/footnotes";
  internal const string FootnoteRelType_Strict = "http://purl.oclc.org/ooxml/officeDocument/relationships/footnotes";
  internal const string HeaderRelType = "http://schemas.openxmlformats.org/officeDocument/2006/relationships/header";
  internal const string HeaderRelType_Strict = "http://purl.oclc.org/ooxml/officeDocument/relationships/header";
  ...
  internal const string StylesRelType_Strict = "http://purl.oclc.org/ooxml/officeDocument/relationships/styles";
  internal const string OleObjectRelType = "http://schemas.openxmlformats.org/officeDocument/2006/relationships/oleObject";
  internal const string OleObjectRelType_Strict = "http://purl.oclc.org/ooxml/officeDocument/relationships/oleObject";
  ...
  internal const string ThemeRelType_Strict = "http://purl.oclc.org/ooxml/officeDocument/relationships/theme";
  internal const string FontRelType = "http://schemas.openxmlformats.org/officeDocument/2006/relationships/font";
  ...
  internal const string ImageRelType_Strict = "http://purl.oclc.org/ooxml/officeDocument/relationships/image";
  ...
  internal const string VbaProjectSignatureRelType = "http://schemas.microsoft.com/office/2006/relationships/vbaProjectSignature";
  internal const string VbaProjectSignatureAgileRelType = "http://schemas.microsoft.com/office/2006/relationships/vbaProjectSignatureAgile";
  ...
  internal const string CustomXmlType = "http://schemas.openxmlformats.org/officeDocument/2006/customXml";
  internal const string CustomXmlPropsRelType = "http://schemas.openxmlformats.org/officeDocument/2006/relationships/customXmlProps";
  internal const string CustomUIRelType = "http://schemas.microsoft.com/office/2006/relationships/ui/extensibility";
  internal const string CustomUI14RelType = "http://schemas.microsoft.com/office/2007/relationships/ui/extensibility";
  internal const string UserCustomizationRelType = "http://schemas.microsoft.com/office/2006/relationships/ui/userCustomization";
  ...
  internal const string ChartColorStyleRelType = "http://schemas.microsoft.com/office/2011/relationships/chartColorStyle";
  internal const string ChartStyleRelType = "http://schemas.microsoft.com/office/2011/relationships/chartStyle";
  internal const string ChartUserShapesRelType = "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chartUserShapes";
  internal const string ChartContentType = "http://schemas.openxmlformats.org/officeDocument/2006/relationships/package";
  internal const string PKG_namespace = "http://schemas.microsoft.com/office/2006/xmlPackage";
  internal const string W_namespace = "http://schemas.openxmlformats.org/wordprocessingml/2006/main";
  internal const string W_strictNamespace = "http://purl.oclc.org/ooxml/wordprocessingml/main";
  internal const string WP_namespace = "http://schemas.openxmlformats.org/drawingml/2006/wordprocessingDrawing";
  internal const string WP_strictNamespace = "http://purl.oclc.org/ooxml/drawingml/wordprocessingDrawing";
  internal const string PIC_namespace = "http://schemas.openxmlformats.org/drawingml/2006/picture";
  internal const string PIC_strictNamespace = "http://purl.oclc.org/ooxml/drawingml/picture";
  internal const string A_namespace = "http://schemas.openxmlformats.org/drawingml/2006/main";
  internal const string A_strictNamespace = "http://purl.oclc.org/ooxml/drawingml/main";
  internal const string A14_namespace = "http://schemas.microsoft.com/office/drawing/2010/main";
  internal const string SVG_namespace = "http://schemas.microsoft.com/office/drawing/2016/SVG/main";
  internal const string R_namespace = "http://schemas.openxmlformats.org/officeDocument/2006/relationships";
  internal const string R_strictNamespace = "http://purl.oclc.org/ooxml/officeDocument/relationships";
  ...
  internal const string M_strictNamespace = "http://purl.oclc.org/ooxml/officeDocument/math";
  ...
  internal const string VT_strictNamespace = "http://purl.oclc.org/ooxml/officeDocument/docPropsVTypes";
  internal const string CHART_namespace = "http://schemas.openxmlformats.org/drawingml/2006/chart";
  internal const string CHART_strictNamespace = "http://purl.oclc.org/ooxml/drawingml/chart";
  internal const string SL_namespace = "http://schemas.openxmlformats.org/schemaLibrary/2006/main";
  internal const string AML_namespace = "http://schemas.microsoft.com/aml/2001/core";
  internal const string DT_namespace = "uuid:C2F41010-65B3-11d1-A29F-00AA00C14882";
  internal const string WML_namespace = "http://schemas.microsoft.com/office/word/2003/wordml";
  internal const string W14_namespace = "http://schemas.microsoft.com/office/word/2010/wordml";
  internal const string WPC_namespace = "http://schemas.microsoft.com/office/word/2010/wordprocessingCanvas";
  ...
  internal const string Diagram_namespace = "http://schemas.openxmlformats.org/drawingml/2006/diagram";
  internal const string Strict_conformance = "strict";
  ...
  internal const string SYMEX_namespace = "http://schemas.microsoft.com/office/word/2015/wordml/symex";
  ...
  internal const string c_userShapesTag = "userShapes";
  internal const string c_externalData = "externalData";
  internal const int TwentiethOfPoint = 20;
  internal const int BorderMultiplier = 8;
  internal const char TOC_SYMBOL = '\u0001';
  internal const char FOOTNOTE_SYMBOL = '\u0002';
  internal const char PAGENUMBER_SYMBOL = '\v';
  ...
  internal const string PackageType = "http://schemas.microsoft.com/office/2006/xmlPackage";
  internal const string RelsPartPath = "/_rels/.rels";
  internal const string DocumentRelsPartPath = "/word/_rels/document.xml.rels";
  internal const string WebSettingsPath = "/word/webSettings.xml";
  internal const string WordMLDocumentPath = "/word/document.xml";
  internal const string WordMLStylePath = "/word/styles.xml";
  internal const string WordMLNumberingPath = "/word/numbering.xml";
  internal const string WordMLSettingsPath = "/word/settings.xml";
  internal const string WordMLHeaderPath = "/word/header";
  internal const string WordMLFooterPath = "/word/footer";
  internal const string WordMLCommentsPath = "/word/comments.xml";
  internal const string WordMLImagePath = "/word/media/image";
  internal const string WordMLFootnotesPath = "/word/footnotes.xml";
  internal const string WordMLEndnotesPath = "/word/endnotes.xml";
  internal const string WordMLAppPath = "/docProps/app.xml";
  internal const string WordMLCorePath = "/docProps/core.xml";
  internal const string WordMLCustomPath = "/docProps/custom.xml";
  internal const string WordMLFontTablePath = "/word/fontTable.xml";
  internal const string WordMLChartsPath = "/word/charts/";
  internal const string WordMLDefaultEmbeddingPath = "/word/embeddings/";
  internal const string WordMLEmbeddingPath = "/word/embeddings/";
  internal const string WordMLDrawingPath = "/word/drawings/";
  internal const string WordMLThemePath = "/word/theme/theme1.xml";
  internal const string WordMLFontsPath = "/word/fonts/";
  internal const string WordMLDiagramPath = "/word/diagrams/";
  internal const string WordMLControlPath = "/word/activeX/";
  internal const string WordMLVbaProject = "/vbaProject.bin";
  internal const string WordMLVbaData = "/vbaData.xml";
  internal const string WordMLVbaProjectPath = "/word/vbaProject.bin";
  internal const string WordMLVbaDataPath = "/word/vbaData.xml";
  internal const string WordMLCustomXMLPath = "/customXml/";
  internal const string WordMLWebSettingsPath = "/word/webSettings.xml";
  internal const string WordMLCustomItemProp1Path = "/customXml/itemProps1.xml";
  internal const string WordMLCustomXMLRelPath = "/customXml/_rels/item1.xml.rels";
  internal const string WordMLFootnoteRelPath = "/word/_rels/footnotes.xml.rels";
  internal const string WordMLEndnoteRelPath = "/word/_rels/endnotes.xml.rels";
  internal const string WordMLSettingsRelPath = "/word/_rels/settings.xml.rels";
  internal const string WordMLNumberingRelPath = "/word/_rels/numbering.xml.rels";
  internal const string WordMLFontTableRelPath = "/word/_rels/fontTable.xml.rels";
  internal const string WordMLCustomXmlPropsRelType = "http://schemas.openxmlformats.org/officeDocument/2006/relationships/customXmlProps";
  internal const string WordMLControlRelType = "http://schemas.microsoft.com/office/2006/relationships/activeXControlBinary";
  internal const string WordMLDiagramContentType = "application/vnd.ms-office.drawingml.diagramDrawing+xml";
}
