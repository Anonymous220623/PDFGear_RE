...
// Type: Syncfusion.DocIO.DLS.XDLSException
...
internal class XDLSException : DLSException
{
  private const string DEF_MESSAGE = "Exception during xml serialization";

  public XDLSException()
    : base("Exception during xml serialization")
  {
  }

  public XDLSException(Exception innerExc)
    : this("Exception during xml serialization", innerExc)
  {
  }
