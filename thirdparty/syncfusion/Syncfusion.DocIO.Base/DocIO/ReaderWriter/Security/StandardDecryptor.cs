...
// Type: Syncfusion.DocIO.ReaderWriter.Security.StandardDecryptor
...
internal class StandardDecryptor
{
  ...
  internal bool CheckPassword(string password)
  {
    ...
    byte[] hash = new SHA1CryptoServiceProvider().ComputeHash(this.Decrypt(verifier.EncryptedVerifier, this.m_arrKey));
