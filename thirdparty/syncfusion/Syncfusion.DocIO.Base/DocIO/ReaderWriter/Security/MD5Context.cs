...
// Type: Syncfusion.DocIO.ReaderWriter.Security.MD5Context
...
internal class MD5Context
{
  ...
  internal uint[] I => this.m_uiI;

  internal uint[] Buffer => this.m_buf;

  internal byte[] InBuffer => this.m_in;

  internal byte[] Digest => this.m_digest;
