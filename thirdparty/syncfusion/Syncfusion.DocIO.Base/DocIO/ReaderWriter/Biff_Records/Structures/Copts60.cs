...
// Type: Syncfusion.DocIO.ReaderWriter.Biff_Records.Structures.Copts60
...
{
  private ushort m_flags = 61440 /*0xF000*/;
  ...
  internal Copts60(DOPDescriptor dopBase) => this.m_dopBase = dopBase;

  internal void Parse(Stream stream) => this.m_flags = BaseWordRecord.ReadUInt16(stream);

  internal void Write(Stream stream) => BaseWordRecord.WriteUInt16(stream, this.m_flags);
}
