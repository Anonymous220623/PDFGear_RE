...
// Type: Syncfusion.CompoundFile.DocIO.Net.CompoundStreamNet
...
internal class CompoundStreamNet : CompoundStream, ICompoundItem
{
  ...
  public Syncfusion.CompoundFile.DocIO.Net.CompoundFile ParentFile => this.m_parentFile;

  public CompoundStreamNet(Syncfusion.CompoundFile.DocIO.Net.CompoundFile file, DirectoryEntry entry)
    : base(entry.Name)
  {
    if (file == null)
