...
// Type: Syncfusion.CompoundFile.DocIO.Net.CompoundStorage
...
{
  private Syncfusion.CompoundFile.DocIO.Net.CompoundFile m_parentFile;
  ...
  public CompoundStorage(Syncfusion.CompoundFile.DocIO.Net.CompoundFile parent, string name, int entryIndex)
  {
  ...
  public CompoundStorage(Syncfusion.CompoundFile.DocIO.Net.CompoundFile parentFile, DirectoryEntry entry)
  {
    if (parentFile == null)
  ...
  public void Dispose()
  {
    if (this.m_parentFile == null)
      return;
    this.m_parentFile = (Syncfusion.CompoundFile.DocIO.Net.CompoundFile) null;
