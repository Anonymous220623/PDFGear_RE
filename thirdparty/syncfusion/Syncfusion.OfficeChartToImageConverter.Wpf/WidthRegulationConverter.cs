...
// Type: Syncfusion.OfficeChartToImageConverter.WidthRegulationConverter
...
internal class WidthRegulationConverter : IValueConverter
{
  public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
  {
    ...
    return (object) (((FrameworkElement) typeof (ChartAxis).GetProperty("Area", System.Reflection.BindingFlags.Instance | System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.GetProperty).GetValue(obj, (object[]) null)).Width / 4.166667);
  }
