...
// Type: Syncfusion.UI.Xaml.Charts.ZoomOut
...
public class ZoomOut : ZoomingToolBarItem
{
  public ZoomOut()
  {
    this.DataContext = (object) this;
    this.DefaultStyleKey = (object) typeof (ZoomOut);
    this.Tag = (object) nameof (ZoomOut);
    ToolTipService.SetToolTip((DependencyObject) this, (object) ChartLocalizationResourceAccessor.Instance.GetString(nameof (ZoomOut)));
  }
  ...
  protected override void OnMouseLeftButtonDown(MouseButtonEventArgs e)
  {
    ...
    foreach (ChartAxisBase2D ax in (Collection<ChartAxis>) this.Source.ChartArea.Axes)
    {
      ...
      {
        double num2 = 0.5;
        this.Source.Zoom(Math.Max(Math.Max(1.0 / ChartMath.MinMax(ax.ZoomFactor, 0.0, 1.0), 1.0) - 0.25, 1.0), num2 > 1.0 ? 1.0 : (num2 < 0.0 ? 0.0 : num2), ax);
      }
      flag = false;
