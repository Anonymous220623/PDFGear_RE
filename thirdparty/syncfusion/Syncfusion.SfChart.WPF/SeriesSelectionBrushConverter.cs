...
// Type: Syncfusion.UI.Xaml.Charts.SeriesSelectionBrushConverter
...
public class SeriesSelectionBrushConverter : IValueConverter
{
  ...
  public SeriesSelectionBrushConverter(ChartSeriesBase series) => this.series = series;

  public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
  {
    if (this.series != null)
    {
      Brush seriesSelectionBrush = this.series.ActualArea.GetSeriesSelectionBrush(this.series);
      if (seriesSelectionBrush != null)
        return (object) seriesSelectionBrush;
