...
// Type: Syncfusion.UI.Xaml.Charts.PolarSeries
...
public class PolarSeries : PolarRadarSeriesBase
{
  public override void CreateSegments()
  {
    ...
    else
    {
      ...
      List<double> doubleList2 = this.ActualXValues as List<double>;
      if (this.IsIndexed || doubleList2 == null)
        doubleList2 = doubleList2 != null ? doubleList2.Select<double, double>((Func<double, double>) (val => xIndexValues++)).ToList<double>() : (this.ActualXValues as List<string>).Select<string, double>((Func<string, double>) (val => xIndexValues++)).ToList<double>();
      if (doubleList2 == null)
        return;
      int index1;
      for (index1 = 0; index1 < this.DataCount; ++index1)
      {
        ...
        if (index2 < this.DataCount)
        {
          if (index1 < this.Segments.Count)
            this.Segments[index1].SetData(doubleList2[index1], this.YValues[index1], doubleList2[index2], this.YValues[index2]);
          else
        ...
        if (this.AdornmentsInfo != null)
        {
          if (index1 < this.Adornments.Count)
            this.Adornments[index1].SetData(doubleList2[index1], this.YValues[index1], doubleList2[index1], this.YValues[index1]);
          else
            this.Adornments.Add(this.CreateAdornment((AdornmentSeries) this, doubleList2[index1], this.YValues[index1], doubleList2[index1], this.YValues[index1]));
        }
      }
      if (this.IsClosed)
        this.CreateSegment(new double[4]
  ...
  {
    return base.CloneSeries((DependencyObject) new PolarSeries());
  }
}
