...
// Type: Syncfusion.CompoundFile.XlsIO.Net.PropertySection
...
public class PropertySection
{
  ...
  public void Parse(Stream stream)
  {
    ...
    for (int index = 0; index < num1; ++index)
    {
      ...
      if (lstProperty.Id < 2)
      {
        ...
        this.m_lstProperties.RemoveAt(index);
    ...
    ref Dictionary<int, string> dictNames)
  {
    ...
    else
    {
      ...
      if (property.Id != 1)
        return;
      this.m_sCodePage = (int) (short) property.Value;
      this.ParseDictionary(stream, ref dictNames);
    }
  }
  ...
  public void Serialize(Stream stream)
  {
    ...
    Dictionary<int, string> dictionary = this.PrepareNames();
    PropertyData propertyData = new PropertyData(1)
    {
      PropertyType = PropertyType.Int16,
      Value = (object) (short) (dictionary.Count == 0 ? 1252 : -535)
    };
