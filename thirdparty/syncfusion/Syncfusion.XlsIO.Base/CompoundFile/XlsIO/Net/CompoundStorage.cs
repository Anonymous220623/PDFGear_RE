...
// Type: Syncfusion.CompoundFile.XlsIO.Net.CompoundStorage
...
internal class CompoundStorage : ICompoundStorage, IDisposable, ICompoundItem
{
  ...
  public CompoundStorage(Syncfusion.CompoundFile.XlsIO.Net.CompoundFile parent, string name, int entryIndex)
  {
  ...
  public CompoundStorage(Syncfusion.CompoundFile.XlsIO.Net.CompoundFile parentFile, DirectoryEntry entry)
  {
    if (parentFile == null)
