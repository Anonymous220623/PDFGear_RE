...
internal class ShapeImplExt
{
  ...
  {
    this.m_parentSheet = worksheetBaseImpl;
    this.m_autoShapeType = autoShapeType;
    this.m_anchorType = AnchorType.TwoCell;
    this.m_logger = new PreservationLogger();
    this.CreateShapeType(autoShapeType);
    ...
    get
    {
      if (this.m_fill == null)
      {
        if (this.m_worksheet != null)
          this.m_fill = new ShapeFillImpl((IApplication) this.m_worksheet.AppImplementation, (object) this.m_worksheet, ExcelFillType.SolidColor, this.m_logger);
        else if (this.m_parentSheet != null)
          this.m_fill = new ShapeFillImpl((IApplication) this.m_parentSheet.AppImplementation, (object) this.m_parentSheet, ExcelFillType.SolidColor, this.m_logger);
      }
      return this.m_fill;
    }
  }
    ...
    get
    {
      if (this.m_line == null)
      {
        if (this.m_worksheet != null)
          ...
          this.m_line = new ShapeLineFormatImpl((IApplication) this.m_parentSheet.AppImplementation, (object) this.m_parentSheet, this.m_logger);
      }
      return this.m_line;
    }
  }
  ...
  {
    get => this.m_parentSheet;
    set => this.m_parentSheet = value;
  }

  internal Dictionary<string, string> ShapeGuide
  {
    get => this.m_shapeGuide == null ? new Dictionary<string, string>() : this.m_shapeGuide;
    set => this.m_shapeGuide = value;
  }

  internal List<Path2D> Path2DList
  {
    get => this.m_pathList == null ? new List<Path2D>() : this.m_pathList;
    set => this.m_pathList = value;
  }

  internal bool IsCustomGeometry
  {
    get => this.m_bCustomGeometry;
    set => this.m_bCustomGeometry = value;
  }

  internal ShapeImplExt Clone(ShapeImpl parent)
  {
    ShapeImplExt parent1 = (ShapeImplExt) this.MemberwiseClone();
    parent1.m_worksheet = parent.ParentShapes.Worksheet;
    if (this.m_fill != null)
    ...
    if (this.m_clientAnchor != null)
      parent1.m_clientAnchor = this.m_clientAnchor.Clone((object) parent1);
    return parent1;
  }
}
