...
// Type: Syncfusion.XlsIO.ODF.Base.ODFImplementation.OParagraph
...
internal class OParagraph : OTextBodyItem
{
  ...
  internal List<OParagraphItem> OParagraphItemCollection
  {
    get
    {
      if (this.m_OParagraphItemCollection == null)
        this.m_OParagraphItemCollection = new List<OParagraphItem>();
      return this.m_OParagraphItemCollection;
    }
    set => this.m_OParagraphItemCollection = value;
  }
  ...
  {
    get => this.m_listLevelNumber;
    set => this.m_listLevelNumber = value;
  }
  ...
  internal void Dispose()
  {
    if (this.m_OParagraphItemCollection != null)
    {
      foreach (OParagraphItem oparagraphItem in this.m_OParagraphItemCollection)
        oparagraphItem.Dispose();
      this.m_OParagraphItemCollection.Clear();
      this.m_OParagraphItemCollection = (List<OParagraphItem>) null;
    }
    if (this.m_anchor == null)
      return;
    this.m_anchor = (Anchor) null;
  }
}
