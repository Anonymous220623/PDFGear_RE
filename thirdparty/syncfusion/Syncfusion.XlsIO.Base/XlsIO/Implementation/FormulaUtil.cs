...
// Type: Syncfusion.XlsIO.Implementation.FormulaUtil
...
public class FormulaUtil : CommonObject
{
  ...
  internal const char AbsoluteCellReference = '$';
  ...
  public static char[] OpenBrackets = new char[5]
  {
    '{',
    '(',
    '"',
  ...
  public static char[] CloseBrackets = new char[5]
  {
    '}',
    ')',
    '"',
  ...
  public static char[] StringBrackets = new char[1]{ '"' };
  public static string[] UnaryOperations = new string[4]
  {
    "%",
    "(",
    "+",
  ...
  public static string[] PlusMinusArray = new string[2]
  {
    "+",
    "-"
  };
  private static readonly SortedList m_listPlusMinus = FormulaUtil.GetSortedList(FormulaUtil.PlusMinusArray);
  public static Dictionary<ExcelFunction, string> FunctionIdToAlias = new Dictionary<ExcelFunction, string>(418);
  public static Dictionary<ExcelFunction, int> FunctionIdToParamCount = new Dictionary<ExcelFunction, int>(418);
  internal static Dictionary<ExcelFunction, int> MissingArgumentsCount = new Dictionary<ExcelFunction, int>();
  internal static readonly List<ExcelFunction> InfiniteParamCountFunctionId = new List<ExcelFunction>();
  public static Dictionary<string, ExcelFunction> FunctionAliasToId = new Dictionary<string, ExcelFunction>();
  public static Dictionary<ExcelFunction, Dictionary<Type, ReferenceIndexAttribute>> FunctionIdToIndex = new Dictionary<ExcelFunction, Dictionary<Type, ReferenceIndexAttribute>>(418);
  public static Dictionary<string, ConstructorInfo> ErrorNameToConstructor = new Dictionary<string, ConstructorInfo>(7);
  ...
  internal static readonly Dictionary<FormulaToken, Ptg> s_hashTokenCodeToPtg = new Dictionary<FormulaToken, Ptg>();
  public static readonly Regex CellReferenceRegex = new Regex("[?\\$|A-Z|a-z]{1,3}\\d+", RegexOptions.Compiled);
  ...
  private static readonly Regex CellMultipleRangeRegex = new Regex("([\\$]?[A-Za-z]{1,3})([\\$]?\\d+)(:([\\$]?[A-Za-z]{1,3})([\\$]?\\d+))+", RegexOptions.Compiled);
  ...
  public static FormulaToken[] NameXCodes = new FormulaToken[3]
  {
    FormulaToken.tNameX1,
    FormulaToken.tNameX2,
    FormulaToken.tNameX3
  };
  public static FormulaToken[] NameCodes = new FormulaToken[3]
  {
    FormulaToken.tName1,
    FormulaToken.tName2,
    FormulaToken.tName3
  ...
  private static readonly ExcelFunction[] m_excel2016Supported = new ExcelFunction[11]
  {
    ExcelFunction.TEXTJOIN,
    ExcelFunction.CONCAT,
    ExcelFunction.IFS,
    ExcelFunction.SWITCH,
    ExcelFunction.MAXIFS,
    ExcelFunction.MINIFS,
    ExcelFunction.FORECAST_ETS,
    ExcelFunction.FORECAST_ETS_SEASONALITY,
    ExcelFunction.FORECAST_ETS_CONFINT,
    ExcelFunction.FORECAST_ETS_STAT,
    ExcelFunction.FORECAST_LINEAR
  };
  private static readonly ExcelFunction[] m_excelOffice365Supported = new ExcelFunction[1]
  {
    ExcelFunction.UNIQUE
  };
  ...
  static FormulaUtil()
  {
    ...
    FormulaUtil.FillMissArgumentsExcelFunction();
  ...
  {
    FormulaUtil.MissingArgumentsCount.Add(ExcelFunction.IFERROR, 2);
    FormulaUtil.MissingArgumentsCount.Add(ExcelFunction.ROUND, 2);
    FormulaUtil.MissingArgumentsCount.Add(ExcelFunction.DAYS, 2);
    FormulaUtil.MissingArgumentsCount.Add(ExcelFunction.BASE, 2);
  }
  ...
  private static void FillExcelFunctions()
  {
    ...
    FormulaUtil.RegisterFunction("TEXTJOIN", ExcelFunction.TEXTJOIN, new ReferenceIndexAttribute[1]
    {
      new ReferenceIndexAttribute(typeof (RefPtg), 2)
    }, -1);
    FormulaUtil.RegisterFunction("CONCAT", ExcelFunction.CONCAT, new ReferenceIndexAttribute[1]
    {
      new ReferenceIndexAttribute(typeof (RefPtg), 2)
    }, -1);
    FormulaUtil.RegisterFunction("IFS", ExcelFunction.IFS, new ReferenceIndexAttribute[1]
    {
      new ReferenceIndexAttribute(typeof (RefPtg), 2)
    }, -1);
    FormulaUtil.RegisterFunction("SWITCH", ExcelFunction.SWITCH, new ReferenceIndexAttribute[1]
    {
      new ReferenceIndexAttribute(typeof (RefPtg), 2)
    }, -1);
    FormulaUtil.RegisterFunction("MAXIFS", ExcelFunction.MAXIFS, new ReferenceIndexAttribute[1]
    {
      new ReferenceIndexAttribute(typeof (RefPtg), 2)
    }, -1);
    FormulaUtil.RegisterFunction("MINIFS", ExcelFunction.MINIFS, new ReferenceIndexAttribute[1]
    {
      new ReferenceIndexAttribute(typeof (RefPtg), 2)
    }, -1);
    FormulaUtil.RegisterFunction("FORECAST.ETS", ExcelFunction.FORECAST_ETS, new ReferenceIndexAttribute[1]
    {
      new ReferenceIndexAttribute(typeof (RefPtg), 2)
    }, -1);
    FormulaUtil.RegisterFunction("FORECAST.ETS.SEASONALITY", ExcelFunction.FORECAST_ETS_SEASONALITY, new ReferenceIndexAttribute[1]
    {
      new ReferenceIndexAttribute(typeof (RefPtg), 2)
    }, -1);
    FormulaUtil.RegisterFunction("FORECAST.LINEAR", ExcelFunction.FORECAST_LINEAR, new ReferenceIndexAttribute[1]
    {
      new ReferenceIndexAttribute(typeof (RefPtg), 2)
    }, 3);
    FormulaUtil.RegisterFunction("FORECAST.ETS.CONFINT", ExcelFunction.FORECAST_ETS_CONFINT, new ReferenceIndexAttribute[1]
    {
      new ReferenceIndexAttribute(typeof (RefPtg), 2)
    }, -1);
    FormulaUtil.RegisterFunction("FORECAST.ETS.STAT", ExcelFunction.FORECAST_ETS_STAT, new ReferenceIndexAttribute[1]
    {
      new ReferenceIndexAttribute(typeof (RefPtg), 2)
    }, -1);
    FormulaUtil.RegisterFunction("UNIQUE", ExcelFunction.UNIQUE, new ReferenceIndexAttribute[1]
    {
      new ReferenceIndexAttribute(typeof (RefPtg), 2)
    }, -1);
  }
  ...
  {
    return this.ParseString(strFormula, sheet, (Dictionary<Type, ReferenceIndexAttribute>) null, 0, hashWorksheetNames, ExcelParseFormulaOptions.RootLevel, 0, 0);
  }
  ...
  public Ptg[] ParseString(
    ...
    bool bR1C1)
  {
    ExcelParseFormulaOptions options = bR1C1 ? ExcelParseFormulaOptions.RootLevel | ExcelParseFormulaOptions.UseR1C1 : ExcelParseFormulaOptions.RootLevel;
  ...
  public Ptg[] ParseString(
    ...
    int iCellColumn)
  {
    bool r1C1 = (options & ExcelParseFormulaOptions.UseR1C1) != ExcelParseFormulaOptions.None;
  ...
  public void CheckFormulaVersion(Ptg[] ptgs)
  {
    ...
    for (int length = ptgs.Length; index < length; ++index)
    {
      if (ptgs[index] is FunctionPtg ptg)
      {
        if (FormulaUtil.IsExcel2007Function(ptg.FunctionIndex) && this.m_book.Version < ExcelVersion.Excel2007)
          throw new NotSupportedException("The formula is not supported in this Version");
        if (FormulaUtil.IsExcel2010Function(ptg.FunctionIndex) && this.m_book.Version < ExcelVersion.Excel2010)
          throw new NotSupportedException("The formula is not supported in this Version");
        if (FormulaUtil.IsExcel2013Function(ptg.FunctionIndex) && this.m_book.Version < ExcelVersion.Excel2013)
          throw new NotSupportedException("The formula is not supported in this Version");
        if (FormulaUtil.IsExcel2016Function(ptg.FunctionIndex) && this.m_book.Version < ExcelVersion.Excel2016)
          throw new NotSupportedException("The formula is not supported in this Version");
      }
    }
  }
  ...
  public bool UpdateNameIndex(Ptg ptg, int[] arrNewIndex)
  {
    ...
    if (FormulaUtil.IndexOf(FormulaUtil.NameCodes, ptg.TokenCode) != -1)
    {
      ...
      int index = namePtg.ExternNameIndexInt - 1;
  ...
  public void SetSeparators(char operandsSeparator, char arrayRowsSeparator)
  {
    ...
    if (str1 == this.m_strOperandsSeparator && str2 == this.m_strArrayRowSeparator || str1 == CultureInfo.CurrentCulture.NumberFormat.NumberDecimalSeparator)
      return;
  ...
  private Ptg CreateConstantPtg(
    ...
    int iCellColumn)
  {
    bool bR1C1 = (options & ExcelParseFormulaOptions.UseR1C1) != ExcelParseFormulaOptions.None;
  ...
  public static Ptg[] ParseExpression(DataProvider provider, int iLength, ExcelVersion version)
  {
    ...
    {
      if (ptgList[index] is RefPtg refPtg && (refPtg.TokenCode == FormulaToken.tRef3d1 || refPtg.TokenCode == FormulaToken.tRef3d2 || refPtg.TokenCode == FormulaToken.tRef3d3) && (refPtg.IsRowIndexRelative || refPtg.IsColumnIndexRelative) && !(ptgList[index] is RefNPtg) && refPtg is Ref3DPtg)
        ptgList[index] = (refPtg as Ref3DPtg).ConvertPtgToNPtg();
    }
  ...
  internal static bool IsValid(DataProvider provider, int iLength)
  {
    ...
    if (iOffset >= iLength)
      return true;
    FormulaToken key = (FormulaToken) provider.ReadByte(iOffset);
    return FormulaUtil.s_hashTokenCodeToPtg.ContainsKey(key);
  }
    ...
    int paramCount)
  {
    ...
    else
    {
      if (paramCount != -1)
        return;
      FormulaUtil.InfiniteParamCountFunctionId.Add(index);
    }
  }
  ...
  public static void UpdateNameIndex(Ptg ptg, int iOldIndex, int iNewIndex)
  {
    ...
    {
      NamePtg namePtg = (NamePtg) ptg;
      if (namePtg.ExternNameIndexInt - 1 != iOldIndex)
        return;
      namePtg.ExternNameIndexInt = iNewIndex + 1;
    }
    else
    {
    ...
    WorksheetImpl destSheet)
  {
    ...
    {
      Ptg arrPtg = arrPtgs[index];
      Ptg ptg = this.ChangeNameReferenceIndex(sourceBook, destBook, destSheet, arrPtg);
      arrPtgs[index] = ptg.Offset(iRowDelta, iColumnDelta, this.m_book);
    }
    return arrPtgs;
  }

  internal Ptg ChangeNameReferenceIndex(
    WorkbookImpl sourceBook,
    WorkbookImpl destBook,
    WorksheetImpl destSheet,
    Ptg ptg)
    ...
    int iCellColumn)
  {
    ...
    ExcelParseFormulaOptions options1 = options;
    if ((options & ExcelParseFormulaOptions.RootLevel) != ExcelParseFormulaOptions.None)
      --options1;
    int index1 = 0;
    ...
    int num3 = (options & ExcelParseFormulaOptions.InArray) == ExcelParseFormulaOptions.None ? 8 : 0;
  ...
  {
    Match match = FormulaUtil.CellReferenceRegex.Match(strFormula);
    return match.Success && strFormula.Contains(match.Value);
  }
    ...
    out string strColumn2)
  {
    ...
    else if (FormulaUtil.IsSuccess(FormulaUtil.CellMultipleRangeRegex.Match(strFormula), strFormula))
    {
      flag = true;
      if (!strFormula.Contains(" "))
      {
        string[] cells = strFormula.Split(':');
        if (cells.Length > 2)
        {
          int maxValue;
          int iFirstColumn = maxValue = int.MaxValue;
          int minValue;
          int iLastColumn = minValue = int.MinValue;
          RangeImpl.GetMinMaxRowColFromCellNames(cells, ref maxValue, ref iFirstColumn, ref minValue, ref iLastColumn);
          strRow1 = maxValue.ToString();
          strRow2 = minValue.ToString();
          strColumn1 = RangeImpl.GetColumnName(iFirstColumn);
          strColumn2 = RangeImpl.GetColumnName(iLastColumn);
        }
      }
    }
    else
  ...
  public static int GetIndex(
    ...
    ExcelParseFormulaOptions options)
  {
    bool flag1 = (options & ExcelParseFormulaOptions.InName) != ExcelParseFormulaOptions.None;
    if (flag1)
      return 1;
    if (indexes == null)
      return 2;
    int num = FormulaUtil.GetExpectedIndex(targetType, indexes, i) - 1;
    bool flag2 = (options & ExcelParseFormulaOptions.RootLevel) != ExcelParseFormulaOptions.None;
    bool flag3 = (options & ExcelParseFormulaOptions.InArray) != ExcelParseFormulaOptions.None;
    bool flag4 = (options & ExcelParseFormulaOptions.ParseComplexOperand) != ExcelParseFormulaOptions.None;
  ...
  {
    return Array.IndexOf<ExcelFunction>(FormulaUtil.m_excelOffice365Supported, functionIndex) >= 0;
  }

  public static bool IsExcel2016Function(ExcelFunction functionIndex)
  {
    return Array.IndexOf<ExcelFunction>(FormulaUtil.m_excel2016Supported, functionIndex) >= 0;
  }
