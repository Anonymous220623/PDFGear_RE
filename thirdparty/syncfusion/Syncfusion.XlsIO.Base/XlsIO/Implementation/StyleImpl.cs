...
// Type: Syncfusion.XlsIO.Implementation.StyleImpl
  ...
  INamedObject
{
    ...
    : this(book)
  {
    ...
    if (!bIsBuiltIn || this.m_book.Version == ExcelVersion.Excel97to2003 || index < 10)
      return;
  ...
  public override void EndUpdate()
  {
    ...
    this.m_book.InnerExtFormats[this.m_xFormat.Index].UpdateFromCurrentExtendedFormatNew(this.m_xFormat, false);
  }
  ...
  {
    return obj is StyleImpl styleImpl && this.Name == styleImpl.Name && this.m_font.Equals((object) styleImpl.m_font) && this.m_xFormat.Equals((object) styleImpl.m_xFormat);
  }
  ...
  internal class BorderSettings
  {
    ...
    public BorderSettings(
      ColorObject color,
      ExcelLineStyle left,
      ExcelLineStyle right,
      ExcelLineStyle top,
      ExcelLineStyle bottom)
    {
      this.BorderColor = color;
      this.Left = left;
      this.Right = right;
    ...
    internal void Dispose()
    {
      ...
      this.BorderColor = (ColorObject) null;
    }
  }
