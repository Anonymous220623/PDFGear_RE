...
// Type: Syncfusion.XlsIO.Implementation.Charts.ChartDataTableImpl
...
public class ChartDataTableImpl : CommonObject, IChartDataTable
{
  ...
  public void Serialize(OffsetArrayList records)
  {
    ...
    if (this.m_arrRecords.Count == 0)
    {
      ...
      record1.Position = ExcelLegendPosition.NotDocked;
  ...
  {
    ChartDataTableImpl chartDataTableImpl = new ChartDataTableImpl(this.Application, parent);
    chartDataTableImpl.m_bIsDisposed = this.m_bIsDisposed;
    if (this.m_arrRecords != null)
    {
      ...
      chartDataTableImpl.m_arrRecords = biffRecordRawList;
    }
    if (this.m_chartDat != null)
      chartDataTableImpl.m_chartDat = (ChartDatRecord) this.m_chartDat.Clone();
  ...
  internal bool HasTextArea => this.m_text != null;
