...
// Type: Syncfusion.XlsIO.Implementation.Charts.ChartValueAxisImpl
...
public class ChartValueAxisImpl : ChartAxisImpl, IChartValueAxis, IChartAxis, IScalable
{
  public static double[] DEF_DISPLAY_UNIT_VALUES = new double[10]
  {
    0.0,
    100.0,
    1000.0,
  ...
  public virtual bool IsMaxCross
  {
    ...
    set
    {
      this.m_chartValueRange.IsMaxCross = value;
      if (!value)
        return;
      this.IsAutoCross = false;
    }
  ...
  [CLSCompliant(false)]
  protected internal ChartValueRangeRecord ChartValueRange
  {
  ...
  public double DisplayUnitCustom
  {
    ...
    set
    {
      ...
      this.DisplayUnit = ExcelChartDisplayUnit.Custom;
    }
  }
  ...
  public ExcelChartDisplayUnit DisplayUnit
  {
    ...
    set
    {
      ...
      else
      {
        ...
        if (this.ParentAxis.ParentChart.ParentWorkbook.Loading)
          return;
  ...
  public bool HasDisplayUnitLabel
  {
    ...
    {
      this.CheckValueRangeRecord();
      if (!this.ParentWorkbook.Loading && this.m_displayUnit == ExcelChartDisplayUnit.None)
  ...
  public IChartTextArea DisplayUnitLabel
  {
    ...
    {
      this.CheckValueRangeRecord();
      return !this.HasDisplayUnitLabel ? (IChartTextArea) null : (IChartTextArea) this.m_displayUnitLabel;
    }
  }
  ...
  protected override void ParseWallsOrFloor(IList<BiffRecordRaw> data, ref int iPos)
  {
    ...
    this.ParentChart.Floor = (IChartWallOrFloor) new ChartWallOrFloorImpl(this.Application, (object) this.ParentChart, false, data, ref iPos);
  }
  ...
  protected void Serialize(OffsetArrayList records, ChartAxisRecord.ChartAxisType axisType)
  {
    ...
    {
      foreach (UnknownRecord shapePropsStream in (IEnumerable<UnknownRecord>) this.m_shapePropsStreams)
        records.Add(shapePropsStream.Clone());
    }
  ...
  private void SerializeDisplayUnits(OffsetArrayList records)
  {
    if (records == null)
      throw new ArgumentNullException(nameof (records));
    if (this.m_displayUnit == ExcelChartDisplayUnit.None)
      return;
  ...
  {
    WorksheetImpl parent = this.FindParent(typeof (WorksheetImpl), true) as WorksheetImpl;
    return this.CheckValueRangeRecord(!this.ParentWorkbook.Loading && !this.ParentWorkbook.Saving && (parent == null || !parent.IsParsing));
  }
  ...
  private void CreateDispalayUnitLabel()
  {
    ...
    if (this.AxisType != ExcelAxisType.Value)
      return;
