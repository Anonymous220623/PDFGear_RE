...
// Type: Syncfusion.XlsIO.Implementation.Charts.ChartDataLabelsImpl
  ...
  IOptimizedUpdate
{
    ...
    : base(application, parent)
  {
    ...
    {
      ChartImpl parent1 = (ChartImpl) chartDataPointImpl.FindParent(typeof (ChartImpl));
      if (parent1 != null && (chartDataPointImpl.FindParent(typeof (WorkbookImpl)) as WorkbookImpl).Version > ExcelVersion.Excel97to2003 && ChartImpl.IsChartExSerieType(parent1.ChartType))
      {
        this.m_textArea.FontName = "Calibri";
        this.m_textArea.Size = 9.0;
      }
    }
    ...
    this.m_textArea.ParagraphType = ChartParagraphType.Default;
  ...
  public bool IsSeriesName
  {
    get
    {
      if (this.m_bHasSeriesOption || this.ParentBook.Version == ExcelVersion.Excel97to2003 || this.ParentBook.IsConverted && !this.ParentBook.IsCreated)
        return this.m_textArea.IsSeriesName;
      return this.ParentBook.Version != ExcelVersion.Excel2007 && this.IsEnableDataLabels;
    }
    set
    {
  ...
  public bool IsCategoryName
  {
    get
    {
      if (!this.m_bHasCategoryOption && !this.ParentBook.IsCreated && (this.ParentBook.Version == ExcelVersion.Excel97to2003 || this.ParentBook.IsConverted))
      {
        if (this.m_textArea.ContainDataLabels)
          return this.m_textArea.IsCategoryName;
        return this.Format != null && this.Format.AttachedLabel.ShowCategoryLabel;
      }
      if (this.m_bHasCategoryOption)
        return this.m_textArea.IsCategoryName;
      return this.ParentBook.Version != ExcelVersion.Excel2007 && this.IsEnableDataLabels;
    }
    set
  ...
  public bool IsValueFromCells
  {
    ...
    set
    {
      ...
      if (this.ParentBook.Loading || !(this.Parent is ChartDataPointImpl) || this.m_conditionCheck)
        return;
  ...
  public IRange ValueFromCellsRange
  {
    ...
    set
    {
      if (value is RangeImpl && value.Row != value.LastRow && value.Column != value.LastColumn)
      {
        this.IsValueFromCells = false;
      }
      else
      {
        this.m_textArea.ValueFromCellsRange = value;
        if (this.ParentBook.Loading || this.Serie == null || value == null)
          return;
  ...
  public bool IsValue
  {
    get
    {
      if (!this.m_bHasValueOption && !this.ParentBook.IsCreated && (this.ParentBook.Version == ExcelVersion.Excel97to2003 || this.ParentBook.IsConverted))
      {
        if (this.m_textArea.ContainDataLabels)
          return this.m_textArea.IsValue;
        return this.Format != null && this.Format.AttachedLabel.ShowActiveValue;
      }
      if (this.m_bHasValueOption)
        return this.m_textArea.IsValue;
      return this.ParentBook.Version != ExcelVersion.Excel2007 && this.IsEnableDataLabels;
    }
    set
  ...
  public bool IsPercentage
  {
    get
    {
      if (!this.m_bHasPercentageOption && !this.ParentBook.IsCreated && (this.ParentBook.Version == ExcelVersion.Excel97to2003 || this.ParentBook.IsConverted))
      {
        if (this.m_textArea.ContainDataLabels)
          return this.m_textArea.IsPercentage;
        return this.Format != null && this.Format.AttachedLabel.ShowPieInPercents;
      }
      if (this.m_bHasPercentageOption)
        return this.m_textArea.IsPercentage;
      return this.ParentBook.Version != ExcelVersion.Excel2007 && this.IsEnableDataLabels;
    }
    set
  ...
  public bool IsBubbleSize
  {
    get
    {
      if (!this.m_bHasBubbleSizeOption && !this.ParentBook.IsCreated && (this.ParentBook.Version == ExcelVersion.Excel97to2003 || this.ParentBook.IsConverted))
      {
        if (this.m_textArea.ContainDataLabels)
          return this.m_textArea.IsBubbleSize;
        return this.Format != null && this.Format.AttachedLabel.ShowBubble;
      }
      if (this.m_bHasBubbleSizeOption)
        return this.m_textArea.IsBubbleSize;
      return this.ParentBook.Version != ExcelVersion.Excel2007 && this.IsEnableDataLabels;
    }
    set
  ...
  public bool IsLegendKey
  {
    get
    {
      if (this.m_bHasLegendKeyOption || this.ParentBook.Version == ExcelVersion.Excel97to2003 || this.ParentBook.IsConverted && !this.ParentBook.IsCreated)
        return this.m_textArea.IsLegendKey;
      return this.ParentBook.Version != ExcelVersion.Excel2007 && this.IsEnableDataLabels;
    }
    set
    {
  ...
  public IChartRichTextString RichText => this.TextArea.RichText;
  ...
  public IChartFrameFormat FrameFormat => this.m_textArea.FrameFormat;
  ...
  public ExcelUnderline Underline
  {
    ...
    set
    {
      this.m_textArea.Underline = !value.Equals((object) ExcelUnderline.DoubleAccounting) && !value.Equals((object) ExcelUnderline.SingleAccounting) ? value : throw new Exception("This underline format is not supported for data labels");
      this.ShowTextProperties = true;
    }
  }
  ...
  public void Serialize(IList<IBiffStorage> records)
  {
    ...
    if (this.m_textArea.ContainDataLabels)
      this.m_textArea.IsShowLabelPercent = this.m_serie.IsPie && this.IsPercentage && this.IsCategoryName && !this.IsValue && !this.IsSeriesName;
    this.SetObjectLink();
  ...
  {
    get => this.m_textArea.ParagraphType;
    set => this.m_textArea.ParagraphType = value;
  }
  ...
  public string NumberFormat
  {
    get
    {
      IChartDataPoint parent = this.Parent as IChartDataPoint;
    ...
    set
    {
      ...
      if (!(this.Parent as IChartDataPoint).IsDefault || this.TextArea == null)
        return;
  ...
  {
    get => this.m_textArea.IsFormula;
    set => this.m_textArea.IsFormula = value;
  }
  ...
  public void UpdateSerieIndex() => this.m_textArea.UpdateSerieIndex(this.m_serie.Index);
  ...
  public ColorObject ColorObject => this.m_textArea.ColorObject;
  ...
  internal bool IsEnableDataLabels
  {
    get => (this.Parent as ChartDataPointImpl).IsDefault && this.m_isAutoEnableDataLabels;
    set => this.m_isAutoEnableDataLabels = value;
  }
  ...
  {
    get => this.m_bFontChanged;
    set => this.m_bFontChanged = value;
  }
}
