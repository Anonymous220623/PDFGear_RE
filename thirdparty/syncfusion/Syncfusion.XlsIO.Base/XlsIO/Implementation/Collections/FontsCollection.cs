...
// Type: Syncfusion.XlsIO.Implementation.Collections.FontsCollection
...
public class FontsCollection : CollectionBaseEx<FontImpl>
{
  ...
  public IFont this[int index]
  {
    get
    {
      ...
      return (IFont) this.InnerList[index];
    }
  }
  ...
  public FontImpl Add(FontImpl font, FontRecord record)
  {
    ...
    return (FontImpl) this.Add((IFont) this.AppImplementation.CreateFont((object) this, font));
  }
  ...
  public IFont Add(IFont font)
  {
    ...
    if (fontImpl.HasParagrapAlign)
    {
      ...
      return (IFont) fontImpl;
    }
    if (this.m_hashFonts.ContainsKey(fontImpl))
    {
      FontImpl hashFont1 = this.m_hashFonts[fontImpl];
      if (fontImpl.CanDispose)
      {
        bool flag = true;
        foreach (KeyValuePair<FontImpl, FontImpl> hashFont2 in this.m_hashFonts)
        {
          if (fontImpl == hashFont2.Key)
          {
            flag = false;
            break;
          }
