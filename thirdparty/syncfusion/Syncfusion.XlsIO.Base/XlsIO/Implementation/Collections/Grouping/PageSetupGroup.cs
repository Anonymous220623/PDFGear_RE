...
// Type: Syncfusion.XlsIO.Implementation.Collections.Grouping.PageSetupGroup
...
public class PageSetupGroup : CommonObject, IPageSetup, IPageSetupBase, IParentApplication
{
  ...
  public ExcelOrder Order
  {
    get
    {
      ExcelOrder order = this.m_sheetGroup[0].PageSetup.Order;
      int i = 1;
      for (int count = this.m_sheetGroup.Count; i < count; ++i)
      {
  ...
  public ExcelPageOrientation Orientation
  {
    get
    {
      ExcelPageOrientation orientation = this.m_sheetGroup[0].PageSetup.Orientation;
      int i = 1;
      for (int count = this.m_sheetGroup.Count; i < count; ++i)
      {
  ...
  public ExcelPaperSize PaperSize
  {
    get
    {
      ExcelPaperSize paperSize = this.m_sheetGroup[0].PageSetup.PaperSize;
      int i = 1;
      for (int count = this.m_sheetGroup.Count; i < count; ++i)
      {
  ...
  public ExcelPrintLocation PrintComments
  {
    get
    {
      ExcelPrintLocation printComments = this.m_sheetGroup[0].PageSetup.PrintComments;
      int i = 1;
      for (int count = this.m_sheetGroup.Count; i < count; ++i)
      {
  ...
  public ExcelPrintErrors PrintErrors
  {
    get
    {
      ExcelPrintErrors printErrors = this.m_sheetGroup[0].PageSetup.PrintErrors;
      int i = 1;
      for (int count = this.m_sheetGroup.Count; i < count; ++i)
      {
  ...
  public IPage EvenPage
  {
    get
    {
      IPage evenPage = this.m_sheetGroup[0].PageSetup.EvenPage;
      int i = 1;
      for (int count = this.m_sheetGroup.Count; i < count; ++i)
      {
        if (this.m_sheetGroup[i].PageSetup.EvenPage != evenPage)
          return (IPage) null;
      }
      return evenPage;
    }
  ...
  public IPage FirstPage
  {
    get
    {
      IPage firstPage = this.m_sheetGroup[0].PageSetup.FirstPage;
      int i = 1;
      for (int count = this.m_sheetGroup.Count; i < count; ++i)
      {
        if (this.m_sheetGroup[i].PageSetup.FirstPage != firstPage)
          return (IPage) null;
      }
      return firstPage;
    }
