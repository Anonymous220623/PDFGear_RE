...
// Type: Syncfusion.XlsIO.Implementation.BorderImplArrayWrapper
...
public class BorderImplArrayWrapper : CommonObject, IBorder, IParentApplication
{
  ...
  public ExcelKnownColors Color
  {
    get
    {
      ExcelKnownColors color = this.m_arrCells[0].Borders[this.m_border].Color;
  ...
  public ColorObject ColorObject
  {
    get
    {
      ColorObject colorObject = this.m_arrCells[0].Borders[this.m_border].ColorObject;
      for (int index = 1; index < this.m_arrCells.Count; ++index)
      {
  ...
  public System.Drawing.Color ColorRGB
  {
    get
    {
      return this.ColorObject == (ColorObject) null ? this.m_arrCells[0].Borders[this.m_border].ColorObject.GetRGB((IWorkbook) this.m_book) : this.ColorObject.GetRGB((IWorkbook) this.m_book);
    }
    set
    {
      int index = 0;
  ...
  public ExcelLineStyle LineStyle
  {
    get
    {
      ExcelLineStyle lineStyle = this.m_arrCells[0].Borders[this.m_border].LineStyle;
      for (int index = 1; index < this.m_arrCells.Count; ++index)
      {
