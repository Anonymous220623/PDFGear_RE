...
// Type: Syncfusion.XlsIO.Implementation.XmlReaders.Shapes.UnknownVmlShapeParser
...
internal class UnknownVmlShapeParser : ShapeParser
{
  public override ShapeImpl ParseShapeType(XmlReader reader, ShapeCollectionBase shapes)
  {
    ...
    int shapeInstance = reader.MoveToAttribute("spt", "urn:schemas-microsoft-com:office:office") ? Convert.ToInt32(double.Parse(reader.Value)) : throw new XmlException();
