...
// Type: Syncfusion.XlsIO.Implementation.XmlSerialization.Constants.PageSetup
...
public sealed class PageSetup
{
  ...
  internal const string EvenHeaderTag = "evenHeader";
  internal const string EvenFooterTag = "evenFooter";
  internal const string FirstHeaderTag = "firstHeader";
  internal const string FirstFooterTag = "firstFooter";
