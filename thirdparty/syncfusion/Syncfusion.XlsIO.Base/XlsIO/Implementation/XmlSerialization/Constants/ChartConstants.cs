...
// Type: Syncfusion.XlsIO.Implementation.XmlSerialization.Constants.ChartConstants
...
public sealed class ChartConstants
{
  ...
  internal const string IntervallocelleTag = "[INTERVALLOCELLE]";
  internal const string SeriesNameTag = "[SERIES NAME]";
  internal const string ValueTag = "[VALUE]";
  internal const string WertTag = "[WERT]";
  ...
  internal const string Extenstion = "ext";
