...
// Type: Syncfusion.XlsIO.Implementation.XmlSerialization.ContentTypes
...
public sealed class ContentTypes
{
  ...
  internal const string Macrosheet = "application/vnd.ms-excel.macrosheet+xml";
  internal const string IntlMacrosheet = "application/vnd.ms-excel.intlmacrosheet+xml";
  ...
  internal const string ChartStyles = "application/vnd.ms-office.chartstyle+xml";
  internal const string ChartColorStyles = "application/vnd.ms-office.chartcolorstyle+xml";
  internal const string VbaProject = "application/vnd.ms-office.vbaProject";
  internal const string BinWorksheet = "application/vnd.ms-excel.worksheet";
  internal const string BinStyles = "application/vnd.ms-excel.styles";
  internal const string BinSST = "application/vnd.ms-excel.sharedStrings";
  internal const string Bin = "application/vnd.ms-excel.sheet.binary.macroEnabled.main";
}
