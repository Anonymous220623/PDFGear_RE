...
// Type: Syncfusion.XlsIO.Implementation.XmlSerialization.Vml
...
public sealed class Vml
{
  ...
  internal const string EndCapAttribute = "endcap";
  ...
  public const int OpacityDegree = 65536 /*0x010000*/;
  public const int DegreeDivider = 255 /*0xFF*/;
  public const double DarkLimit = 0.5;
  internal const string PrintObject = "PrintObject";
