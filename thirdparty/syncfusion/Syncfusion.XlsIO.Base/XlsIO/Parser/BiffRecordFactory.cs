...
// Type: Syncfusion.XlsIO.Parser.BiffRecordFactory
...
public class BiffRecordFactory
{
  ...
  private static void FillFactory()
  {
    ...
    BiffRecordFactory.m_dict[246] = (BiffRecordRaw) new PivotNameRecord();
    BiffRecordFactory.m_dict[80 /*0x50*/] = (BiffRecordRaw) new DataConsolidationInfoRecord();
    ...
    BiffRecordFactory.m_dict[180] = (BiffRecordRaw) new RowColumnFiledIdRecord();
    BiffRecordFactory.m_dict[181] = (BiffRecordRaw) new LineItemArrayRecord();
    ...
    BiffRecordFactory.m_dict[443] = (BiffRecordRaw) new SQLDataTypeIdRecord();
    BiffRecordFactory.m_dict[205] = (BiffRecordRaw) new PivotStringRecord();
    ...
    BiffRecordFactory.m_dict[220] = (BiffRecordRaw) new ExternalSourceInfoRecord();
    ...
    BiffRecordFactory.m_dict[241] = (BiffRecordRaw) new ViewExtendedInfoRecord();
    BiffRecordFactory.m_dict[227] = (BiffRecordRaw) new PivotViewSourceRecord();
    BiffRecordFactory.m_dict[202] = (BiffRecordRaw) new PivotBooleanRecord();
    BiffRecordFactory.m_dict[290] = (BiffRecordRaw) new CacheDataExRecord();
    ...
    BiffRecordFactory.m_dict[178] = (BiffRecordRaw) new PivotViewItemRecord();
    BiffRecordFactory.m_dict[177] = (BiffRecordRaw) new PivotViewFieldsRecord();
    BiffRecordFactory.m_dict[248] = (BiffRecordRaw) new PivotNamePairRecord();
    ...
    BiffRecordFactory.m_dict[240 /*0xF0*/] = (BiffRecordRaw) new RuleDataRecord();
    BiffRecordFactory.m_dict[182] = (BiffRecordRaw) new PageItemRecord();
    ...
    BiffRecordFactory.m_dict[200] = (BiffRecordRaw) new PivotIndexListRecord();
    ...
    BiffRecordFactory.m_dict[203] = (BiffRecordRaw) new PivotErrorRecord();
    BiffRecordFactory.m_dict[197] = (BiffRecordRaw) new DataItemRecord();
    ...
    BiffRecordFactory.m_dict[208 /*0xD0*/] = (BiffRecordRaw) new PivotSourceInfoRecord();
    BiffRecordFactory.m_dict[201] = (BiffRecordRaw) new PivotDoubleRecord();
    BiffRecordFactory.m_dict[206] = (BiffRecordRaw) new PivotDateTimeRecord();
    BiffRecordFactory.m_dict[209] = (BiffRecordRaw) new PageItemNameCountRecord();
    ...
    BiffRecordFactory.m_dict[213] = (BiffRecordRaw) new StreamIdRecord();
    BiffRecordFactory.m_dict[176 /*0xB0*/] = (BiffRecordRaw) new PivotViewDefinitionRecord();
    BiffRecordFactory.m_dict[251] = (BiffRecordRaw) new PivotFormatRecord();
    ...
    BiffRecordFactory.m_dict[247] = (BiffRecordRaw) new SelectionInfoRecord();
    BiffRecordFactory.m_dict[242] = (BiffRecordRaw) new RuleFilterRecord();
    BiffRecordFactory.m_dict[207] = (BiffRecordRaw) new PivotEmptyRecord();
    BiffRecordFactory.m_dict[210] = (BiffRecordRaw) new PageItemIndexesRecord();
    ...
    BiffRecordFactory.m_dict[256 /*0x0100*/] = (BiffRecordRaw) new PivotViewFieldsExRecord();
    BiffRecordFactory.m_dict[199] = (BiffRecordRaw) new PivotFieldRecord();
    BiffRecordFactory.m_dict[249] = (BiffRecordRaw) new ParsedExpressionRecord();
    ...
    BiffRecordFactory.m_dict[259] = (BiffRecordRaw) new PivotFormulaRecord();
    BiffRecordFactory.m_dict[198] = (BiffRecordRaw) new CacheDataRecord();
  ...
  public static BiffRecordRaw GetRecord(
    int type,
    BinaryReader reader,
    ...
    byte[] arrBuffer)
  {
    ...
    record?.FillRecord(reader, provider, decryptor, arrBuffer);
    return record;
  }
  ...
  public static BiffRecordRaw GetRecord(int type, BinaryReader reader, byte[] arrBuffer)
  {
    if (reader == null)
      throw new ArgumentNullException(nameof (reader));
    BiffRecordRaw record = BiffRecordFactory.GetRecord(type);
    record?.FillRecord(reader, (DataProvider) null, (IDecryptor) null, arrBuffer);
    return record;
  }
  ...
  public static BiffRecordRaw GetRecord(
    ...
    byte[] arrBuffer)
  {
    return BiffRecordFactory.GetRecord(BiffRecordFactory.ExtractRecordType(reader), reader, provider, (IDecryptor) null, arrBuffer);
  }
  ...
  public static BiffRecordRaw GetRecord(
    ...
    byte[] arrBuffer)
  {
    return BiffRecordFactory.GetRecord(BiffRecordFactory.ExtractRecordType(reader), reader, provider, decryptor, arrBuffer);
  }
