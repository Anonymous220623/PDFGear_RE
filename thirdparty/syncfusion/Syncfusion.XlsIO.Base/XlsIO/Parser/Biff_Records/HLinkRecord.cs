...
// Type: Syncfusion.XlsIO.Parser.Biff_Records.HLinkRecord
...
[CLSCompliant(false)]
public class HLinkRecord : BiffRecordRawWithArray
{
  ...
  private const string DEF_BACKSLASH = "..\\";
  ...
  public static byte[] GUID_STDLINK_BYTES = HLinkRecord.GUID_STDLINK.ToByteArray();
  public static byte[] GUID_URLMONIKER_BYTES = HLinkRecord.GUID_URLMONIKER.ToByteArray();
  public static byte[] GUID_FILEMONIKER_BYTES = HLinkRecord.GUID_FILEMONIKER.ToByteArray();
  public static byte[] FILE_UNKNOWN = new byte[24]
  {
    byte.MaxValue,
    byte.MaxValue,
    (byte) 173,
  ...
  public static byte[] FILE_UNKNOWN2 = new byte[2]
  {
    (byte) 3,
    (byte) 0
  };
  ...
  public string FileName
  {
    get
    {
      string fileName = this.m_strFileName;
      if (this.DirUpLevel > (ushort) 0)
      {
        for (int index = 1; index <= (int) this.DirUpLevel; ++index)
          fileName = "..\\" + fileName;
      }
      return fileName;
    }
