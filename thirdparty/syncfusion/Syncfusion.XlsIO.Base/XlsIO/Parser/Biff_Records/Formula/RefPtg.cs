...
// Type: Syncfusion.XlsIO.Parser.Biff_Records.Formula.RefPtg
...
public class RefPtg : Ptg, IRangeGetterToken, IRangeGetter, IToken3D, IRectGetter
{
  ...
  public override byte[] ToByteArray(ExcelVersion version)
  {
    ...
    if (version == ExcelVersion.Excel97to2003)
    {
      ...
      {
        FormulaToken formulaToken = !(this is RefNPtg) ? this.GetCorrespondingErrorCode() : (this as RefNPtg).GetErrorCode();
        byteArray[0] = (byte) formulaToken;
      }
      BitConverter.GetBytes((ushort) this.m_iRowIndex).CopyTo((Array) byteArray, index1);
      int index2 = index1 + 2;
      byteArray[index2] = (byte) this.m_iColumnIndex;
      int index3 = index2 + 1;
      byteArray[index3] = this.m_options;
      return byteArray;
    }
    if (version == ExcelVersion.Excel97to2003)
      throw new ArgumentOutOfRangeException(nameof (version));
    ...
    int index4 = index1 + 4;
    BitConverter.GetBytes((short) ((int) (short) ((int) (short) this.m_iColumnIndex | (int) (short) ((XlsbDataHolder.ReadBit(this.m_options, 6) ? 1 : 0) << 14)) | (int) (short) ((XlsbDataHolder.ReadBit(this.m_options, 7) ? 1 : 0) << 15))).CopyTo((Array) byteArray, index4);
    int num = index4 + 2;
    return byteArray;
  }
  ...
  public override void InfillPTG(DataProvider provider, ref int offset, ExcelVersion version)
  {
    ...
    else
    {
      ...
      offset += 4;
      short num = provider.ReadInt16(offset);
      this.m_iColumnIndex = (int) (ushort) ((uint) num << 2) >> 2;
      this.m_options = (byte) ((uint) (ushort) ((uint) num >> 14) << 6);
      offset += 2;
    }
  }

  internal void SetOptions(byte data) => this.m_options = data;
}
