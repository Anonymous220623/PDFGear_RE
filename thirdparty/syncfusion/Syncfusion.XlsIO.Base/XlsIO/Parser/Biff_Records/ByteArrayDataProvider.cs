...
// Type: Syncfusion.XlsIO.Parser.Biff_Records.ByteArrayDataProvider
...
public class ByteArrayDataProvider : DataProvider
{
  ...
  {
    return this.m_arrData.Length >= iOffset + 2 ? BitConverter.ToInt16(this.m_arrData, iOffset) : (short) 0;
  }

  public override int ReadInt32(int iOffset)
  {
    return this.m_arrData.Length >= iOffset + 4 ? BitConverter.ToInt32(this.m_arrData, iOffset) : 0;
  }
  ...
  public override void CopyTo(
    ...
    int iLength)
  {
    if (iLength <= 0 || iSourceOffset + iLength > this.m_arrData.Length)
      return;
  ...
  protected override void OnDispose() => this.m_arrData = (byte[]) null;
