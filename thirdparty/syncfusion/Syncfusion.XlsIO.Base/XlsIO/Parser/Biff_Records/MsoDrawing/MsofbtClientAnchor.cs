...
// Type: Syncfusion.XlsIO.Parser.Biff_Records.MsoDrawing.MsofbtClientAnchor
...
[Syncfusion.XlsIO.Parser.Biff_Records.MsoDrawing.MsoDrawing(MsoRecords.msofbtClientAnchor)]
[CLSCompliant(false)]
public class MsofbtClientAnchor : MsoBase
{
  ...
  public override int GetStoreSize(ExcelVersion version) => !this.m_bShortVersion ? 18 : 8;

  public override bool Equals(object obj)
  {
    return obj is MsofbtClientAnchor msofbtClientAnchor && this.m_iTopRow.Equals(msofbtClientAnchor.m_iTopRow) && this.m_uiLeft.Equals(msofbtClientAnchor.m_uiLeft);
  }
}
