...
// Type: Syncfusion.XlsIO.Parser.Biff_Records.DBCellRecord
...
public class DBCellRecord : BiffRecordWithStreamPos
{
  ...
  public override int GetStoreSize(ExcelVersion version) => 4 + this.m_arrCellOffset.Length * 2;
}
