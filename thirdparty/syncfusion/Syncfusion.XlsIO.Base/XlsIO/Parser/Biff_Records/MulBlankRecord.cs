...
// Type: Syncfusion.XlsIO.Parser.Biff_Records.MulBlankRecord
...
[CLSCompliant(false)]
public class MulBlankRecord : CellPositionBase, IMultiCellRecord, ICellPositionFormat
{
  ...
  protected override void ParseCellData(DataProvider provider, int iOffset, ExcelVersion version)
  {
    ...
    this.m_iLastCol = version != ExcelVersion.Excel97to2003 ? provider.ReadInt32(iOffset) : (int) provider.ReadUInt16(iOffset);
