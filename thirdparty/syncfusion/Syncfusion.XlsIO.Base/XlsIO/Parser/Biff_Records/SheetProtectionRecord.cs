...
// Type: Syncfusion.XlsIO.Parser.Biff_Records.SheetProtectionRecord
...
public class SheetProtectionRecord : BiffRecordRaw
{
  ...
  public override int GetStoreSize(ExcelVersion version) => !this.m_bIsContainProtection ? 19 : 23;
}
