...
// Type: Syncfusion.XlsIO.Parser.Biff_Records.Charts.ChartSerAuxErrBarRecord
...
public class ChartSerAuxErrBarRecord : BiffRecordRaw
{
  ...
  {
    get => (ExcelErrorBarType) this.m_ErrorBarType;
  ...
  public override int GetStoreSize(ExcelVersion version) => 14;
