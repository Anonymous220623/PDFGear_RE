...
// Type: Syncfusion.XlsIO.Parser.Biff_Records.Charts.ChartTextRecord
...
public class ChartTextRecord : BiffRecordRaw
{
  ...
  {
    get => (ExcelChartBackgroundMode) this.m_usBkgMode;
  ...
  {
    get => (ExcelKnownColors) this.m_usColorIndex;
  ...
  public ExcelDataLabelPosition DataLabelPlacement
  {
    get
    {
      return (ExcelDataLabelPosition) BiffRecordRaw.GetUInt16BitsByMask(this.m_usOptions2, (ushort) 15);
    }
