...
// Type: Syncfusion.XlsIO.Parser.Biff_Records.Charts.ChartLineFormatRecord
...
public class ChartLineFormatRecord : BiffRecordRaw
{
  ...
  {
    get => (ExcelChartLinePattern) this.m_usLinePattern;
    set => this.m_usLinePattern = (ushort) value;
  }

  public ExcelChartLineWeight LineWeight
  {
    get => (ExcelChartLineWeight) this.m_usLineWeight;
  ...
  public override void InfillInternalData(DataProvider provider, int iOffset, ExcelVersion version)
  {
    ...
    iOffset += 4;
    if (this.m_usLinePattern == (ushort) 9)
      this.m_usLinePattern = (ushort) 2;
