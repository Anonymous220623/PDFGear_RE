...
// Type: Syncfusion.XlsIO.Parser.Biff_Records.Charts.ChartSertocrtRecord
...
[CLSCompliant(false)]
public class ChartSertocrtRecord : BiffRecordRaw
{
  ...
  {
    get => this.m_usChartGroup;
    set => this.m_usChartGroup = value;
  }
  ...
  {
    this.m_usChartGroup = provider.ReadUInt16(iOffset);
  }

  public override void InfillInternalData(DataProvider provider, int iOffset, ExcelVersion version)
  {
    this.m_iLength = this.GetStoreSize(version);
    provider.WriteUInt16(iOffset, this.m_usChartGroup);
  }
