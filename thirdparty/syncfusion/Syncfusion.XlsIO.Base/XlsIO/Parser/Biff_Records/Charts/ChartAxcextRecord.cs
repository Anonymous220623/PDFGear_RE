...
// Type: Syncfusion.XlsIO.Parser.Biff_Records.Charts.ChartAxcextRecord
...
public class ChartAxcextRecord : BiffRecordRaw
{
  ...
  {
    get => (ExcelChartBaseUnit) this.m_usMajorUnits;
  ...
  {
    get => (ExcelChartBaseUnit) this.m_usMinorUnits;
    set => this.m_usMinorUnits = (ushort) value;
  }

  public ExcelChartBaseUnit BaseUnits
  {
    get => (ExcelChartBaseUnit) this.m_usBaseUnits;
