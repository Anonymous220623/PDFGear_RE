...
// Type: Syncfusion.XlsIO.Parser.Biff_Records.CFRecord
...
[CLSCompliant(false)]
[Biff(TBIFFRecord.CF)]
public class CFRecord : BiffRecordRaw, ICloneable
{
  ...
  {
    get => (ExcelFontVertialAlignment) this.m_usEscapmentType;
    set
    {
  ...
  public ExcelUnderline FontUnderline
  {
    get
    {
      return !Enum.IsDefined(typeof (ExcelUnderline), (object) (ExcelUnderline) this.m_Underline) ? ExcelUnderline.None : (ExcelUnderline) this.m_Underline;
    }
    set
    {
  ...
  public ExcelLineStyle LeftBorderStyle
  {
    get
    {
      return (ExcelLineStyle) BiffRecordRaw.GetUInt16BitsByMask(this.m_usBorderLineStyles, (ushort) 15);
    }
    set
    {
  ...
  public ExcelLineStyle RightBorderStyle
  {
    get
    {
      return (ExcelLineStyle) ((int) BiffRecordRaw.GetUInt16BitsByMask(this.m_usBorderLineStyles, (ushort) 240 /*0xF0*/) >> 4);
    }
    set
    {
  ...
  public ExcelLineStyle TopBorderStyle
  {
    get
    {
      return (ExcelLineStyle) ((int) BiffRecordRaw.GetUInt16BitsByMask(this.m_usBorderLineStyles, (ushort) 3840 /*0x0F00*/) >> 8);
    }
    set
    {
  ...
  public ExcelLineStyle BottomBorderStyle
  {
    get
    {
      return (ExcelLineStyle) ((int) BiffRecordRaw.GetUInt16BitsByMask(this.m_usBorderLineStyles, (ushort) 61440 /*0xF000*/) >> 12);
    }
    set
    {
  ...
  public ExcelPattern PatternStyle
  {
    get
    {
      return (ExcelPattern) ((int) BiffRecordRaw.GetUInt16BitsByMask(this.m_usPatternStyle, (ushort) 64512) >> 10);
    }
    set
    {
    ...
    ExcelVersion version)
  {
    ...
    ++iOffset;
    if (provider.ReadByte(iOffset) != (byte) 0)
    {
