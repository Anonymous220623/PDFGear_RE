...
// Type: Syncfusion.XlsIO.Parser.Biff_Records.NameRecord
...
public class NameRecord : BiffRecordRaw
{
  ...
  public static string[] PREDEFINED_NAMES = new string[16 /*0x10*/]
  {
    "Consolidate_Area",
    "Auto_Open",
    "Auto_Close",
  ...
  public Ptg[] FormulaTokens
  {
    ...
    set
    {
      ...
      {
        int formulaLen;
        this.m_arrFormulaData = FormulaUtil.PtgArrayToByteArray(value, out formulaLen, ExcelVersion.Excel2007);
    ...
    ExcelVersion version)
  {
    ...
    try
    {
      if (this.m_usFormulaDataSize > (ushort) 0)
