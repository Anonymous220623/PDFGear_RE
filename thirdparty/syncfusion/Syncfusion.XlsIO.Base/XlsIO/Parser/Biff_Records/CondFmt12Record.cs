...
// Type: Syncfusion.XlsIO.Parser.Biff_Records.CondFmt12Record
...
[CLSCompliant(false)]
public class CondFmt12Record : BiffRecordRaw
{
  ...
  public override int GetStoreSize(ExcelVersion version) => 26 + this.m_arrCells.Count * 8;
