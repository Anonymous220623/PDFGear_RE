...
// Type: Syncfusion.XlsIO.Parser.Biff_Records.ExtendedFormatRecord
...
public class ExtendedFormatRecord : BiffRecordRaw
{
  ...
  {
    get => (ExcelLineStyle) BiffRecordRaw.GetUInt16BitsByMask(this.m_usBorderOptions, (ushort) 15);
    set
    {
      this.m_bHashValid = false;
      BiffRecordRaw.SetUInt16BitsByMask(ref this.m_usBorderOptions, (ushort) 15, (ushort) value);
      if (value != ExcelLineStyle.None && this.LeftBorderPaletteIndex == (ushort) 0)
      {
  ...
  public ExcelLineStyle BorderRight
  {
    get
    {
      return (ExcelLineStyle) ((int) BiffRecordRaw.GetUInt16BitsByMask(this.m_usBorderOptions, (ushort) 240 /*0xF0*/) >> 4);
    }
    set
    {
      this.m_bHashValid = false;
      BiffRecordRaw.SetUInt16BitsByMask(ref this.m_usBorderOptions, (ushort) 240 /*0xF0*/, (ushort) ((uint) (ushort) value << 4));
      if (value != ExcelLineStyle.None && this.RightBorderPaletteIndex == (ushort) 0)
      {
  ...
  public ExcelLineStyle BorderTop
  {
    get
    {
      return (ExcelLineStyle) ((int) BiffRecordRaw.GetUInt16BitsByMask(this.m_usBorderOptions, (ushort) 3840 /*0x0F00*/) >> 8);
    }
    set
    {
      this.m_bHashValid = false;
      BiffRecordRaw.SetUInt16BitsByMask(ref this.m_usBorderOptions, (ushort) 3840 /*0x0F00*/, (ushort) ((uint) (ushort) value << 8));
      if (value != ExcelLineStyle.None && this.TopBorderPaletteIndex == (ushort) 0)
      {
  ...
  public ExcelLineStyle BorderBottom
  {
    get
    {
      return (ExcelLineStyle) ((int) BiffRecordRaw.GetUInt16BitsByMask(this.m_usBorderOptions, (ushort) 61440 /*0xF000*/) >> 12);
    }
    set
    {
      this.m_bHashValid = false;
      BiffRecordRaw.SetUInt16BitsByMask(ref this.m_usBorderOptions, (ushort) 61440 /*0xF000*/, (ushort) ((uint) (ushort) value << 12));
      if (value != ExcelLineStyle.None && this.BottomBorderPaletteIndex == (ushort) 0)
      {
  ...
  {
    get => (ExcelHAlign) BiffRecordRaw.GetUInt16BitsByMask(this.m_usAlignmentOptions, (ushort) 7);
    set
    {
      this.m_bHashValid = false;
  ...
  public ExcelVAlign VAlignmentType
  {
    get
    {
      return (ExcelVAlign) ((int) BiffRecordRaw.GetUInt16BitsByMask(this.m_usAlignmentOptions, (ushort) 112 /*0x70*/) >> 4);
    }
    set
    {
      this.m_bHashValid = false;
    ...
    ExcelVersion version)
  {
    ...
    if (this.m_usFillPattern == (ushort) 0 && this.FillForeground != (ushort) 65)
  ...
  public int CompareTo(ExtendedFormatRecord twin)
  {
    ...
    if (num21 != 0)
      return num21;
    if (this.m_book != null && twin.m_book != null && this.m_book == twin.m_book)
    {
      int num22 = (int) this.m_usFontIndex - (int) twin.m_usFontIndex;
      if (num22 != 0)
        return num22;
    }
    return (int) this.m_usParentXFIndex - (int) twin.m_usParentXFIndex;
  }
