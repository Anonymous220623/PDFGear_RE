...
// Type: Syncfusion.Windows.Controls.Tools.AutomationPeer.DropDownMenuItemAutomationPeer
...
public class DropDownMenuItemAutomationPeer(DropDownMenuItem control) : 
  FrameworkElementAutomationPeer((FrameworkElement) control)
{
  ...
  {
    return string.IsNullOrEmpty(base.GetClassNameCore()) ? "DropDownMenuItem" : base.GetClassNameCore();
  }
  ...
  private DropDownMenuItem MyOwner => (DropDownMenuItem) this.Owner;
}
