...
// Type: Syncfusion.Windows.Controls.Tools.AutomationPeer.DropDownButtonAdvAutomationPeer
...
public class DropDownButtonAdvAutomationPeer(DropDownButtonAdv control) : 
  FrameworkElementAutomationPeer((FrameworkElement) control)
{
  ...
  {
    return string.IsNullOrEmpty(base.GetClassNameCore()) ? "DropDownButtonAdv" : base.GetClassNameCore();
  }
  ...
  private DropDownButtonAdv MyOwner => (DropDownButtonAdv) this.Owner;
}
