...
// Type: Syncfusion.Windows.Shared.WeekNumberCell
...
public class WeekNumberCell : Cell
{
  ...
  static WeekNumberCell()
  {
    FrameworkElement.DefaultStyleKeyProperty.OverrideMetadata(typeof (WeekNumberCell), (PropertyMetadata) new FrameworkPropertyMetadata((object) typeof (WeekNumberCell)));
    UIElement.FocusableProperty.OverrideMetadata(typeof (WeekNumberCell), (PropertyMetadata) new FrameworkPropertyMetadata((object) false));
    Border.CornerRadiusProperty.AddOwner(typeof (WeekNumberCell));
  }
