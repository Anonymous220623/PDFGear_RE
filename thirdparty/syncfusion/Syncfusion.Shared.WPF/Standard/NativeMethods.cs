...
internal static class NativeMethods
{
  ...
  {
    return 8 == IntPtr.Size ? NativeMethods.SetClassLongPtr64(hwnd, nIndex, dwNewLong) : new IntPtr(NativeMethods.SetClassLongPtr32(hwnd, nIndex, (int) dwNewLong.ToInt64()));
  }
  ...
  {
    return 8 == IntPtr.Size ? NativeMethods.SetWindowLongPtr64(hwnd, nIndex, dwNewLong) : new IntPtr(NativeMethods.SetWindowLongPtr32(hwnd, nIndex, (int) dwNewLong.ToInt64()));
  }
