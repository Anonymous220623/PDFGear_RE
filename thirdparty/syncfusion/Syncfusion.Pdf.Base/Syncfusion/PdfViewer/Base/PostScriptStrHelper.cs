...
// Type: Syncfusion.PdfViewer.Base.PostScriptStrHelper
...
internal class PostScriptStrHelper
{
  ...
  public PostScriptStrHelper(string str) => this.value = str.ToCharArray();

  public PostScriptStrHelper(int capacity) => this.value = new char[capacity];
