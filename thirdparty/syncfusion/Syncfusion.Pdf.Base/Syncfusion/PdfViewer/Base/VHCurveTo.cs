...
// Type: Syncfusion.PdfViewer.Base.VHCurveTo
...
internal class VHCurveTo : Operator
{
  public override void Execute(CharacterBuilder interpreter)
  {
    ...
    if (operands.Count % 8 != 0 && operands.Count % 8 != 1)
    {
      ...
      Operator.CurveTo(interpreter, 0, firstAsInt1, firstAsInt2, firstAsInt3, firstAsInt4, firstAsInt5);
      while (operands.Count / 8 > 0)
      {
        ...
        Operator.CurveTo(interpreter, firstAsInt6, 0, firstAsInt7, firstAsInt8, 0, firstAsInt9);
        Operator.CurveTo(interpreter, 0, firstAsInt10, firstAsInt11, firstAsInt12, firstAsInt13, firstAsInt14);
      }
      operands.Clear();
    }
    else
    {
      while (operands.Count / 8 > 0)
      {
        ...
        Operator.CurveTo(interpreter, 0, firstAsInt15, firstAsInt16, firstAsInt17, firstAsInt18, 0);
        Operator.CurveTo(interpreter, firstAsInt19, 0, firstAsInt20, firstAsInt21, firstAsInt23, firstAsInt22);
      }
      operands.Clear();
    }
  }
