...
// Type: Syncfusion.PdfViewer.Base.HVCurveTo
...
internal class HVCurveTo : Operator
{
  public override void Execute(CharacterBuilder interpreter)
  {
    ...
    if (operands.Count % 8 != 0 && operands.Count % 8 != 1)
    {
      ...
      Operator.CurveTo(interpreter, firstAsInt1, 0, firstAsInt2, firstAsInt3, firstAsInt5, firstAsInt4);
      while (operands.Count / 8 > 0)
      {
        ...
        Operator.CurveTo(interpreter, 0, firstAsInt6, firstAsInt7, firstAsInt8, firstAsInt9, 0);
        Operator.CurveTo(interpreter, firstAsInt10, 0, firstAsInt11, firstAsInt12, firstAsInt14, firstAsInt13);
      }
      operands.Clear();
    }
    else
    {
      while (operands.Count / 8 > 0)
      {
        ...
        Operator.CurveTo(interpreter, firstAsInt15, 0, firstAsInt16, firstAsInt17, 0, firstAsInt18);
        Operator.CurveTo(interpreter, 0, firstAsInt19, firstAsInt20, firstAsInt21, firstAsInt22, firstAsInt23);
      }
      operands.Clear();
    }
  }
