...
// Type: Syncfusion.PdfViewer.Base.Type1Converters
...
internal static class Type1Converters
{
  ...
  {
    Type1Converters.EncodingConverter = new EncodingConverter();
    Type1Converters.PostScriptObjectConverter = new PostScriptObjectConverter();
  }
}
