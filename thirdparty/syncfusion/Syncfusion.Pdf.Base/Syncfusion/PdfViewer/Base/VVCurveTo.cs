...
// Type: Syncfusion.PdfViewer.Base.VVCurveTo
...
internal class VVCurveTo : Operator
{
  public override void Execute(CharacterBuilder interpreter)
  {
    ...
    Operator.CurveTo(interpreter, dxa, firstAsInt1, firstAsInt2, firstAsInt3, 0, firstAsInt4);
    while (operands.Count / 4 > 0)
    {
      ...
      Operator.CurveTo(interpreter, 0, firstAsInt5, firstAsInt6, firstAsInt7, 0, firstAsInt8);
    }
    operands.Clear();
  }
}
