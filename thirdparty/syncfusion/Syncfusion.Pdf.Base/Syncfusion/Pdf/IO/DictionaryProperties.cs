...
internal class DictionaryProperties
{
  ...
  internal const string RV = "RV";
  internal const string Prop_Build = "Prop_Build";
  public const string ModifyDate = "ModifyDate";
  public const string dc = "dc";
  internal const string Calibrate = "Calibrate";
  internal const string CustomData = "CustomData";
  public const string pdfx = "pdfx";
  ...
  internal const string IDTree = "IDTree";
  ...
  internal const string ClassMap = "ClassMap";
  ...
  internal const string ActualText = "ActualText";
  ...
  internal const string StructParent = "StructParent";
  ...
  internal const string OCSPs = "OCSPs";
  internal const string CRLs = "CRLs";
  internal const string VRI = "VRI";
  internal const string DSS = "DSS";
  internal const string AFRelationship = "AFRelationship";
  internal const string AF = "AF";
  internal const string Alternative = "Alternative";
  internal const string Source = "Source";
  internal const string Unspecified = "Unspecified";
  internal const string SlopeType = "SlopeType";
  internal const string NumberFormat = "NumberFormat";
  internal const string FD = "FD";
  internal const string SS = "SS";
  internal const string Measure = "Measure";
  internal const string RT = "RT";
  internal const string RL = "RL";
  internal const string MeasurementTypes = "MeasurementTypes";
  internal const string TargetUnitConversion = "TargetUnitConversion";
  internal const string PolyLineAngle = "PolyLineAngle";
  ...
  internal const string CIDFontType0C = "CIDFontType0C";
  ...
  internal const string PrinterMark = "PrinterMark";
  internal const string TrapNet = "TrapNet";
  ...
  internal const string StmF = "StmF";
  internal const string StrF = "StrF";
  ...
  internal const string Interpolate = "Interpolate";
  ...
  internal const string Subj = "Subj";
  ...
  internal const string Caret = "Caret";
  ...
  internal const string Squiggly = "Squiggly";
  ...
  internal const string OCGLock = "Locked";
  internal const string OCGViewState = "ViewState";
  ...
  public const string PageScaling = "PageScaling";
  internal const string Duplex = "Duplex";
  internal const string Timestamp = "DocTimeStamp";
  internal const string RfcFilter = "ETSI.RFC3161";
  internal const string Approved = "APPROVED";
  internal const string AsIs = "AS IS";
  internal const string Confidential = "CONFIDENTIAL";
  internal const string Departmental = "DEPARTMENTAL";
  ...
  internal const string ForComment = "FOR COMMENT";
  internal const string ForPublicRelease = "FOR PUBLIC RELEASE";
  internal const string NotApproved = "NOT APPROVED";
  internal const string NotForPublicRelease = "NOT FOR PUBLIC RELEASE";
  internal const string Sold = "SOLD";
  internal const string TopSecret = "TOP SECRET";
  internal const string Completed = "COMPLETED";
  internal const string Void = "VOID";
  internal const string InformationOnly = "INFORMATION ONLY";
  internal const string PreliminaryResults = "PRELIMINARY RESULTS";
  internal const string n0 = "n0";
  internal const string n1 = "n1";
  internal const string n2 = "n2";
  internal const string n3 = "n3";
  internal const string n4 = "n4";
  internal const string FRM = "FRM";
  internal const string State = "State";
  internal const string StateModel = "StateModel";
  internal const string IRT = "IRT";
  internal const string Accepted = "Accepted";
  internal const string Cancelled = "Cancelled";
  internal const string Complete = "Completed";
  internal const string Rejected = "Rejected";
  internal const string Unmarked = "Unmarked";
  internal const string Review = "Review";
  internal const string None = "None";
  internal const string Version = "Version";
  internal const string AuthEvent = "AuthEvent";
  internal const string DL = "DL";
  internal const string LLO = "LLO";
  internal const string TextColor = "TextColor";
  internal const string OverlayText = "OverlayText";
  internal const string Redact = "Redact";
  internal const string Templates = "Templates";
  internal const string XRefStm = "XRefStm";
}
