...
// Type: Syncfusion.Pdf.Parsing.SystemFontDiv
...
internal class SystemFontDiv : SystemFontOperator
{
  public override void Execute(SystemFontBuildChar buildChar)
  {
    ...
    double firstAsInt = (double) buildChar.Operands.GetFirstAsInt();
    buildChar.Operands.AddLast((object) (firstAsInt / lastAsReal));
  }
}
