...
// Type: Syncfusion.Pdf.Parsing.Separation
...
internal class Separation : Colorspace
{
  ...
  {
    return this.AlternateColorspace.GetColor(this.AlternateColorspace.ToParams(this.Function.ColorTransferFunction(this.ToDouble(pars))));
  }
