...
// Type: Syncfusion.Pdf.Parsing.SystemFontEExec
...
internal class SystemFontEExec : SystemFontPostScriptOperator
{
  public override void Execute(SystemFontInterpreter interpreter)
  {
    ...
    SystemFontEExecEncryption encrypt = new SystemFontEExecEncryption(interpreter.Reader);
