...
// Type: Syncfusion.Pdf.Parsing.SystemFontCharacters
...
internal static class SystemFontCharacters
{
  ...
  public static bool IsValidNumberChar(SystemFontIPostScriptReader reader)
  {
    ...
    switch (ch)
    {
      case '+':
      case '-':
        return SystemFontCharacters.IsDigitOrDecimalPoint((char) reader.Peek(1));
      default:
        return SystemFontCharacters.IsDigitOrDecimalPoint(ch);
    }
  }
