...
// Type: Syncfusion.Pdf.Parsing.SystemFontPostScriptArray
...
internal class SystemFontPostScriptArray : 
  ...
  IEnumerable
{
  ...
  public static SystemFontPostScriptArray MatrixIdentity
  {
    get
    {
      return new SystemFontPostScriptArray(new object[6]
      {
        (object) 1,
        (object) 0,
        (object) 0,
  ...
  public SystemFontPostScriptArray() => this.store = new List<object>();
  ...
  {
    double res1;
    SystemFontHelper.UnboxReal(this.store[0], out res1);
    double res2;
    SystemFontHelper.UnboxReal(this.store[1], out res2);
    double res3;
    SystemFontHelper.UnboxReal(this.store[2], out res3);
    double res4;
    SystemFontHelper.UnboxReal(this.store[3], out res4);
    double res5;
    SystemFontHelper.UnboxReal(this.store[4], out res5);
    double res6;
    SystemFontHelper.UnboxReal(this.store[5], out res6);
    return new SystemFontMatrix(res1, res2, res3, res4, res5, res6);
  }
