...
// Type: Syncfusion.Pdf.Parsing.SystemFontMatrix
...
internal struct SystemFontMatrix
{
  ...
  public double Determinant
  {
    get
    {
      switch (this.type)
      {
        ...
        case SystemFontMatrixTypes.Scaling | SystemFontMatrixTypes.Translation:
    ...
    : this()
  {
    ...
    this.type = SystemFontMatrixTypes.Unknown;
  ...
  public static bool operator !=(SystemFontMatrix a, SystemFontMatrix b) => !(a == b);

  public bool IsIdentity() => this == SystemFontMatrix.Identity;

  public SystemFontMatrix Translate(double offsetX, double offsetY)
  {
    if (this.type == SystemFontMatrixTypes.Identity)
      this.SetMatrix(1.0, 0.0, 0.0, 1.0, offsetX, offsetY, SystemFontMatrixTypes.Translation);
    else if (this.type == SystemFontMatrixTypes.Unknown)
    {
      this.OffsetX += offsetX;
      this.OffsetY += offsetY;
    }
    else
    {
      this.OffsetX += offsetX;
      this.OffsetY += offsetY;
      this.type |= SystemFontMatrixTypes.Translation;
    }
    return this;
  }
  ...
  public SystemFontMatrix ScaleAppend(
    double scaleX,
    double scaleY,
    double centerX,
    double centerY)
  ...
  {
    SystemFontMatrix systemFontMatrix = new SystemFontMatrix();
    ...
    systemFontMatrix.SetMatrix(num, m12, -m12, num, offsetX, offsetY, SystemFontMatrixTypes.Unknown);
  ...
  public Point Transform(Point point)
  {
    ...
    return new Point((int) (x * this.M11 + y * this.M21 + this.OffsetX), (int) (x * this.M12 + y * this.M22 + this.OffsetY));
  }
  ...
  {
    return obj != null && obj is SystemFontMatrix systemFontMatrix && this.Equals(systemFontMatrix);
  }
  ...
  {
    this.type = SystemFontMatrixTypes.Identity;
    ...
    else
    {
      if (this.M11 != 1.0 || this.M22 != 1.0)
        this.type = SystemFontMatrixTypes.Scaling;
      if (this.OffsetX != 0.0 || this.OffsetY != 0.0)
        this.type |= SystemFontMatrixTypes.Translation;
      if ((this.type & (SystemFontMatrixTypes.Scaling | SystemFontMatrixTypes.Translation)) != SystemFontMatrixTypes.Identity)
        return;
      this.type = SystemFontMatrixTypes.Identity;
    }
  }
