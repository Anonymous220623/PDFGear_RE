...
// Type: Syncfusion.Pdf.Parsing.SystemFontKeywords
...
internal static class SystemFontKeywords
{
  ...
  internal static object GetValue(string keyword)
  {
    ...
    {
      case "StandardEncoding":
        return (object) new SystemFontPostScriptArray((object[]) SystemFontPredefinedEncodings.StandardEncoding);
      default:
        return (object) null;
    }
  }
