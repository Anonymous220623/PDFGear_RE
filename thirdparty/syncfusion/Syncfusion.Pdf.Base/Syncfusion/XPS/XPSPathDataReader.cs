...
// Type: Syncfusion.XPS.XPSPathDataReader
...
internal class XPSPathDataReader
{
  ...
  internal XPSPathDataReader(string text)
  {
    this.m_text = text;
    this.m_position = 0;
  }
  ...
  internal bool TryReadFloat(out float value)
  {
    ...
    value = XPSRenderer.ParseFloat(match.Captures[0].Value);
    return true;
  }
  ...
  internal bool TryReadPoint(out PointF val)
  {
    ...
    val = new PointF(XPSRenderer.ParseFloat(strArray[0]), XPSRenderer.ParseFloat(strArray[1]));
    return true;
  }
...
label_5:
    ...
    for (int index = 0; index < strArray.Length; ++index)
      pointFList.Add(new PointF(XPSRenderer.ParseFloat(strArray[index].Split(this.m_commaSeparator)[0]), XPSRenderer.ParseFloat(strArray[index].Split(this.m_commaSeparator)[1])));
