...
// Type: Syncfusion.XPS.OXPSDataReader
...
internal class OXPSDataReader
{
  ...
  internal string ReadName(string data, ref int position)
  {
    string str = "";
  ...
  internal bool ReadBoolean(string data, ref int position)
  {
    bool result = false;
  ...
  internal float ReadDouble(string data, ref int position)
  {
    float result = 0.0f;
  ...
  internal PointF ReadPoint(string data, ref int position)
  {
  ...
  internal Matrix ReadMatrix(string data, ref int position)
  {
