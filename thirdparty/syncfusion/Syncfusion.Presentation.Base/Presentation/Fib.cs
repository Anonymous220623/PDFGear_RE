...
// Type: Syncfusion.Presentation.Fib
...
internal class Fib
{
  ...
  internal void Write(Stream stream)
  {
    ...
    stream.Write(this.m_fibRgFcLcbBlob, 0, this.m_fibRgFcLcbBlob.Length);
    byte[] bytes2 = BitConverter.GetBytes(this.m_cswNew);
    stream.Write(bytes2, 0, bytes2.Length);
    stream.Write(this.m_fibRgCswNew, 0, this.m_fibRgCswNew.Length);
  }
