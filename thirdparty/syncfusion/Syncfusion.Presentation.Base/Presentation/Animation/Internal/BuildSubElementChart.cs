...
// Type: Syncfusion.Presentation.Animation.Internal.BuildSubElementChart
...
internal class BuildSubElementChart
{
  ...
  internal BuildSubElementChart Clone() => (BuildSubElementChart) this.MemberwiseClone();
}
