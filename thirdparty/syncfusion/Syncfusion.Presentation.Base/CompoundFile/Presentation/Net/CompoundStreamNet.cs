...
// Type: Syncfusion.CompoundFile.Presentation.Net.CompoundStreamNet
...
internal class CompoundStreamNet : CompoundStream, ICompoundItem
{
  ...
  public Syncfusion.CompoundFile.Presentation.Net.CompoundFile ParentFile => this.m_parentFile;

  public CompoundStreamNet(Syncfusion.CompoundFile.Presentation.Net.CompoundFile file, DirectoryEntry entry)
    : base(entry.Name)
  {
    if (file == null)
