...
// Type: Syncfusion.CompoundFile.Presentation.Net.DIF
...
internal class DIF
{
  ...
  public DIF(Stream stream, FileHeader header)
  {
    ...
    {
      long sectorOffset = Syncfusion.CompoundFile.Presentation.Net.CompoundFile.GetSectorOffset(sectorIndex, sectorShift1);
