...
internal class ShapeStyle
{
  ...
  private void SerializeShapeProperties(XmlWriter writer)
  {
    ...
    {
      if (this.m_shapeProperties.ShapeFillType == OfficeFillType.SolidColor)
      {
  ...
  {
    xmlTextWriter.WriteStartElement("a", nameof (lnRef), "http://schemas.openxmlformats.org/drawingml/2006/main");
  ...
  internal void Write(XmlWriter xmlTextWriter)
  {
    ...
    else
    {
      if (!this.shape.IsCreated)
        return;
      xmlTextWriter.WriteStartElement(this.attribute, "style", "http://schemas.openxmlformats.org/drawingml/2006/spreadsheetDrawing");
