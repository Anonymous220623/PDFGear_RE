...
// Type: Syncfusion.OfficeChart.Implementation.WorksheetBaseImpl
...
internal abstract class WorksheetBaseImpl : 
  CommonObject,
  INamedObject,
  IParseable,
  ITabSheet,
  ...
  ICloneParent
{
  ...
  public const OfficeKnownColors DEF_DEFAULT_TAB_COLOR = ~OfficeKnownColors.Black;
  ...
  private OfficeSheetProtection m_parseProtection = ~OfficeSheetProtection.None;
  ...
  public IOfficeChartShapes Charts
  {
    get
    {
      ...
      if (this.m_charts == null)
        this.m_charts = new WorksheetChartsCollection(this.Application, (object) this);
      return (IOfficeChartShapes) this.m_charts;
    }
  }

  public string CodeName
  {
    get => this.m_strCodeName == null ? this.m_strName : this.m_strCodeName;
    internal set => this.m_strCodeName = value;
  }
  ...
  public virtual bool ProtectDrawingObjects
  {
    get
    {
      return this.ProtectContents && (this.InnerProtection & OfficeSheetProtection.Objects) == OfficeSheetProtection.None;
    }
  }
  ...
  public virtual bool ProtectScenarios
  {
    get
    {
      return this.ProtectContents && (this.InnerProtection & OfficeSheetProtection.Scenarios) == OfficeSheetProtection.None;
    }
  }
  ...
  public bool IsPasswordProtected
  {
    ...
    {
      this.CheckParseOnDemand();
      if (this.m_parseProtection.ToString() != "-1" && !(this.Workbook as WorkbookImpl).Saving)
        return true;
  ...
  public virtual ChartColor TabColorObject
  {
    get
    {
      if (this.m_tabColor == (ChartColor) null)
        this.m_tabColor = new ChartColor(~OfficeKnownColors.Black);
  ...
  public virtual OfficeKnownColors TabColor
  {
    get
    {
      return !(this.m_tabColor != (ChartColor) null) ? ~OfficeKnownColors.Black : this.m_tabColor.GetIndexed((IWorkbook) this.m_book);
    }
    set
    {
      if (this.m_tabColor == (ChartColor) null)
  ...
  public virtual Color TabColorRGB
  {
    get
    {
      return !(this.m_tabColor != (ChartColor) null) ? WorksheetBaseImpl.DEF_DEFAULT_TAB_COLOR_RGB : this.m_tabColor.GetRGB((IWorkbook) this.m_book);
    }
    set
    {
      if (this.m_tabColor == (ChartColor) null)
        this.m_tabColor = new ChartColor(OfficeKnownColors.Black);
      this.m_bTabColorRGB = true;
  ...
  {
    get => (OfficeKnownColors) this.m_windowTwo.HeaderColor;
    set
    {
  ...
  public virtual OfficeSheetProtection Protection
  {
    get
    {
      return this.m_sheetProtection == null ? OfficeSheetProtection.None : (OfficeSheetProtection) this.m_sheetProtection.ProtectedOptions;
    }
  }
  ...
  protected internal virtual OfficeSheetProtection InnerProtection
  {
    get
    {
      return this.m_sheetProtection == null ? this.UnprotectedOptions : (OfficeSheetProtection) this.m_sheetProtection.ProtectedOptions;
    }
  ...
  public OfficeWorksheetVisibility Visibility
  {
    ...
    set
    {
      if (this.Visibility == value)
        return;
      OfficeWorksheetVisibility visibility = this.Visibility;
      this.m_visiblity = value;
      if (!this.m_book.IsWorkbookOpening && value != OfficeWorksheetVisibility.Visible)
      {
  ...
  private bool ProtectionMeaningDirect
  {
    get
    {
      return (this.DefaultProtectionOptions & OfficeSheetProtection.Content) != OfficeSheetProtection.None;
    }
  }
  ...
  internal bool HasTabColorRGB => this.m_bTabColorRGB;
  ...
  {
    if ((int) this.m_book.WindowOne.SelectedTab == this.RealIndex && !this.m_book.IsWorkbookOpening)
      return;
  ...
  public void Protect(string password, OfficeSheetProtection options)
  {
    ...
    int version = (int) this.m_book.Version;
  ...
  {
    if (this.m_sheetProtection != null || this.m_parseProtection == OfficeSheetProtection.None || this.m_parseProtection == ~OfficeSheetProtection.None)
      return;
    this.m_sheetProtection = (SheetProtectionRecord) BiffRecordFactory.GetRecord(TBIFFRecord.SheetProtection);
  ...
  protected void ParseProtect(ProtectRecord protectRecord)
  {
    ...
    if (this.ProtectionMeaningDirect)
      this.m_parseProtection |= OfficeSheetProtection.Content;
    else
      this.m_parseProtection &= ~OfficeSheetProtection.Content;
  }
  ...
  protected void ParseObjectProtect(ObjectProtectRecord objectProtect)
  {
    if (!objectProtect.IsProtected)
      return;
    if (this.ProtectionMeaningDirect)
      this.m_parseProtection |= OfficeSheetProtection.Objects;
    else
      this.m_parseProtection &= ~OfficeSheetProtection.Objects;
  }
  ...
  protected void ParseScenProtect(ScenProtectRecord scenProtect)
  {
    if (!scenProtect.IsProtected)
      return;
    if (this.ProtectionMeaningDirect)
      this.m_parseProtection |= OfficeSheetProtection.Scenarios;
    else
      this.m_parseProtection &= ~OfficeSheetProtection.Scenarios;
  }
  ...
  {
    this.TabColor = sheetLayout != null ? (OfficeKnownColors) sheetLayout.ColorIndex : throw new ArgumentNullException(nameof (sheetLayout));
  }
  ...
  protected virtual void SerializeMsoDrawings(OffsetArrayList records)
  {
    ...
    if (this.m_shapes == null || this.m_shapes.Count <= 0 || (this.Application.SkipOnSave & OfficeSkipExtRecords.Drawings) == OfficeSkipExtRecords.Drawings)
      return;
  ...
  protected void SerializeSheetProtection(OffsetArrayList records)
  {
    if (records == null)
      throw new ArgumentNullException(nameof (records));
    if (this.m_sheetProtection == null || !this.ContainsProtection)
      return;
  ...
  protected virtual void SerializePageLayoutView(OffsetArrayList records)
  {
    if (records == null)
      throw new ArgumentNullException(nameof (records));
    WorksheetImpl worksheetImpl = this as WorksheetImpl;
    if (this.m_layout == null || worksheetImpl.View != OfficeSheetView.PageLayout)
      return;
  ...
  protected virtual void SerializeMacrosSupport(OffsetArrayList records)
  {
    if (records == null)
      throw new ArgumentNullException(nameof (records));
    if ((this.Application.SkipOnSave & OfficeSkipExtRecords.Macros) == OfficeSkipExtRecords.Macros || this.m_strCodeName == null || !this.m_book.HasMacros)
      return;
    ...
    Dictionary<int, int> hashExtFormatIndexes)
  {
    if ((flags & OfficeWorksheetCopyFlags.ClearBefore) != OfficeWorksheetCopyFlags.None)
      this.ClearAll(flags);
    if ((flags & OfficeWorksheetCopyFlags.CopyOptions) != OfficeWorksheetCopyFlags.None)
  ...
  protected virtual void CopyOptions(WorksheetBaseImpl sourceSheet)
  {
    ...
    if (strCodeName == null || strCodeName.Length <= 0)
      return;
    this.m_strCodeName = this.GenerateUniqueName(new WorksheetBaseImpl.NameGetter(this.GetCodeName), strCodeName);
  }
  ...
  private string GenerateUniqueName(WorksheetBaseImpl.NameGetter getName, string sourceCodeName)
  {
    ...
    for (int count = tabSheets.Count; index < count; ++index)
    {
      if (this.Index != index)
      {
        string key = getName(tabSheets[index]);
  ...
  private void CopyTabColor(WorksheetBaseImpl sourceSheet)
  {
    ...
    if (sourceSheet.m_tabColor == (ChartColor) null)
    {
  ...
  public override void Dispose()
  {
    ...
    this.m_tabColor = (ChartColor) null;
  }
  ...
  {
    this.SetParent(application, (object) workSheet);
    this.FindParents();
    this.InitializeCollections();
  }
