...
// Type: Syncfusion.OfficeChart.Implementation.Charts.ChartTrendLineImpl
...
internal class ChartTrendLineImpl : CommonObject, IOfficeChartTrendLine
{
  ...
  private static Dictionary<OfficeTrendLineType, string> m_hashNames = new Dictionary<OfficeTrendLineType, string>(6);
  ...
  {
    ChartTrendLineImpl.m_hashNames.Add(OfficeTrendLineType.Exponential, "Expon. ");
    ChartTrendLineImpl.m_hashNames.Add(OfficeTrendLineType.Linear, "Linear ");
    ChartTrendLineImpl.m_hashNames.Add(OfficeTrendLineType.Logarithmic, "Log. ");
    ChartTrendLineImpl.m_hashNames.Add(OfficeTrendLineType.Moving_Average, " per. Mov. Avg. ");
    ChartTrendLineImpl.m_hashNames.Add(OfficeTrendLineType.Polynomial, "Poly. ");
    ChartTrendLineImpl.m_hashNames.Add(OfficeTrendLineType.Power, "Power ");
  }
  ...
  public IOfficeChartBorder Border => (IOfficeChartBorder) this.m_border;
  ...
  public double Intercept
  {
    ...
    set
    {
      ...
      this.CheckRecordProprties();
      this.CheckIntercept();
      this.m_record.NumIntercept = this.Type != OfficeTrendLineType.Exponential || value > 0.0 ? value : throw new ArgumentOutOfRangeException(nameof (Intercept));
    }
  }
  ...
  public bool InterceptIsAuto
  {
    ...
    set
    {
      ...
      if (value)
        ...
        this.Intercept = this.Type == OfficeTrendLineType.Exponential ? 1.0 : 0.0;
    }
  }
  ...
  public string Name
  {
    get
    {
      ...
      OfficeTrendLineType type = this.Type;
  ...
  public IOfficeChartTextArea DataLabel
  {
    get
    {
      return this.m_textArea != null ? (IOfficeChartTextArea) this.m_textArea : throw new NotSupportedException("Cannot return data label.");
    }
  }
  ...
  public void ClearFormats()
  {
    ...
    this.m_type = OfficeTrendLineType.Linear;
  ...
  {
    if (this.Type == OfficeTrendLineType.Moving_Average)
  ...
  private void CheckIntercept()
  {
    switch (this.Type)
    {
      case OfficeTrendLineType.Logarithmic:
      case OfficeTrendLineType.Power:
  ...
  private void OnTypeChanging(OfficeTrendLineType type)
  {
    ...
    if (flag && this.m_serie.PointNumber < 3 && !this.m_serie.ParentBook.IsWorkbookOpening)
      throw new NotSupportedException("This trendline type is supported only if data points count is greater than 2");
    this.m_record.Order = flag || type == OfficeTrendLineType.Polynomial ? (byte) 2 : (byte) 1;
    this.m_record.NumIntercept = ChartSerAuxTrendRecord.DEF_NAN_VALUE;
  }

  private void CheckOrder(int value)
  {
    if (this.m_type != OfficeTrendLineType.Polynomial && this.m_type != OfficeTrendLineType.Moving_Average)
      throw new NotSupportedException("This property doesnot support in current trendline type.");
    int num = 6;
    if (this.m_type != OfficeTrendLineType.Moving_Average)
  ...
  private void UpdateType()
  {
    ...
    ChartSeriesCollection parentSeries = this.m_serie.ParentSeries;
    this.m_type = !flag || this.m_record.Order >= (byte) 2 ? (OfficeTrendLineType) this.m_record.RegressionType : OfficeTrendLineType.Linear;
    ++parentSeries.TrendIndex;
  }
