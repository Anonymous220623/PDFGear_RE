...
// Type: Syncfusion.OfficeChart.Implementation.Charts.ChartErrorBarsImpl
...
internal class ChartErrorBarsImpl : CommonObject, IOfficeChartErrorBars
{
  ...
  public OfficeErrorBarInclude Include
  {
    ...
    set
    {
      if (value == this.Include)
        return;
      if (!this.m_serie.ParentBook.IsWorkbookOpening && !this.CheckInclude(value))
  ...
  public IRange PlusIRange
  {
    ...
    set
    {
      ...
      if (this.m_include != OfficeErrorBarInclude.Both)
        this.m_include = this.m_minusRange == null ? OfficeErrorBarInclude.Plus : OfficeErrorBarInclude.Both;
      this.m_errorBarRecord.ErrorBarType = OfficeErrorBarType.Custom;
      this.m_plusRange = value;
      if (this.m_serie.ParentBook.IsWorkbookOpening)
        return;
  ...
  public IOfficeDataRange PlusRange
  {
    get
    {
      return (IOfficeDataRange) new ChartDataRange((IOfficeChart) this.m_serie.ParentChart)
      {
        Range = this.PlusIRange
      };
    }
    set
    {
      this.PlusIRange = this.m_serie.ParentChart.Workbook.Worksheets[0][value.FirstRow, value.FirstColumn, value.LastRow, value.LastColumn];
    }
  }
  ...
  public IRange MinusIRange
  {
    ...
    set
    {
      if (value == null)
        throw new ArgumentNullException("PlusRange");
      if (this.m_include != OfficeErrorBarInclude.Both)
        this.m_include = this.m_plusRange == null ? OfficeErrorBarInclude.Minus : OfficeErrorBarInclude.Both;
      this.m_errorBarRecord.ErrorBarType = OfficeErrorBarType.Custom;
  ...
  public IOfficeDataRange MinusRange
  {
    get
    {
      return (IOfficeDataRange) new ChartDataRange((IOfficeChart) this.m_serie.ParentChart)
      {
        Range = this.MinusIRange
      };
    }
    set
    {
      this.MinusIRange = this.m_serie.ParentChart.Workbook.Worksheets[0][value.FirstRow, value.FirstColumn, value.LastRow, value.LastColumn];
    }
  }
  ...
  {
    this.Type = OfficeErrorBarType.Fixed;
    this.Border.AutoFormat = true;
    this.HasCap = true;
    this.NumberValue = this.m_bIsY ? 10.0 : 1.0;
    this.m_include = OfficeErrorBarInclude.Both;
  ...
  private void Parse(IList<BiffRecordRaw> data)
  {
    ...
    this.m_include = flag ? OfficeErrorBarInclude.Plus : OfficeErrorBarInclude.Minus;
    if (range == null)
      return;
    if (flag)
  ...
  public void Serialize(IList<IBiffStorage> records)
  {
    ...
    {
      bool bIsPlus = this.m_include == OfficeErrorBarInclude.Plus;
  ...
  private void SerializeAiRecords(IList<IBiffStorage> records, bool bIsPlus)
  {
    ...
    if (this.Type == OfficeErrorBarType.Custom && this.m_bIsY)
    {
  ...
  {
    if (this.Type != OfficeErrorBarType.Custom)
      return true;
    if (value == OfficeErrorBarInclude.Plus)
    {
      this.m_minusRange = (IRange) null;
      return this.m_plusRange != null;
    }
    if (value == OfficeErrorBarInclude.Minus)
    {
      this.m_plusRange = (IRange) null;
  ...
  public ChartErrorBarsImpl Clone(object parent, Dictionary<string, string> hashNewNames)
  {
    ...
    if (this.m_minusRangeValues != null)
      parent1.m_minusRangeValues = CloneUtils.CloneArray(this.m_minusRangeValues);
    if (this.m_plusRangeValues != null)
      parent1.m_plusRangeValues = CloneUtils.CloneArray(this.m_plusRangeValues);
    if (this.m_chartAi != null)
      parent1.m_chartAi = (ChartAIRecord) this.m_chartAi.Clone();
    parent1.m_include = this.m_include;
    if (this.m_markerFormat != null)
      parent1.m_markerFormat = (ChartMarkerFormatRecord) CloneUtils.CloneCloneable((ICloneable) this.m_markerFormat);
    return parent1;
  }
}
