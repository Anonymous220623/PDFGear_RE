...
// Type: Syncfusion.OfficeChart.Implementation.Charts.ChartLayoutImpl
...
internal class ChartLayoutImpl : CommonObject, IOfficeChartLayout, IParentApplication
{
    ...
    : this(application, parent, false, false, true)
  {
    if (!(chartObject is IOfficeChart))
      return;
    this.m_chart = (IOfficeChart) chartObject;
    if ((this.m_chart as ChartImpl).Parent == null || !((this.m_chart as ChartImpl).Parent is IShape))
      return;
    this.m_chartShape = (IShape) (this.m_chart as ChartImpl).Parent;
  }
  ...
  public IOfficeChartManualLayout ManualLayout
  {
    get
    {
      if (this.m_manualLayout == null)
        this.m_manualLayout = (IOfficeChartManualLayout) new ChartManualLayoutImpl(this.Workbook.Application, (object) this);
  ...
  public LayoutModes LeftMode
  {
    ...
    set
    {
      if (this.Parent is ChartLegendImpl || this.Parent is ChartPlotAreaImpl)
      {
        this.ManualLayout.LeftMode = value;
      }
      else
      {
        if (!(this.Parent is ChartTextAreaImpl) || !(this.Parent is ChartTextAreaImpl) || (this.Parent as ChartTextAreaImpl).Parent is ChartLegendImpl)
          return;
        this.ManualLayout.LeftMode = value;
      }
    }
  ...
  public LayoutModes TopMode
  {
    ...
    set
    {
      if (this.Parent is ChartLegendImpl || this.Parent is ChartPlotAreaImpl)
      {
        this.ManualLayout.TopMode = value;
      }
      else
      {
        if (!(this.Parent is ChartTextAreaImpl) || !(this.Parent is ChartTextAreaImpl) || (this.Parent as ChartTextAreaImpl).Parent is ChartLegendImpl)
  ...
  public LayoutModes WidthMode
  {
    ...
    set
    {
      if (this.Parent is ChartLegendImpl || this.Parent is ChartPlotAreaImpl)
      {
        this.ManualLayout.WidthMode = value;
      }
      else
      {
        if (!(this.Parent is ChartTextAreaImpl) || !(this.Parent is ChartTextAreaImpl) || (this.Parent as ChartTextAreaImpl).Parent is ChartLegendImpl)
  ...
  public LayoutModes HeightMode
  {
    ...
    set
    {
      if (this.Parent is ChartLegendImpl || this.Parent is ChartPlotAreaImpl)
      {
        this.ManualLayout.HeightMode = value;
      }
      else
      {
        if (!(this.Parent is ChartTextAreaImpl) || !(this.Parent is ChartTextAreaImpl) || (this.Parent as ChartTextAreaImpl).Parent is ChartLegendImpl)
