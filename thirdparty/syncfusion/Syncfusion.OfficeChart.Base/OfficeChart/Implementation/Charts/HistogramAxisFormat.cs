...
// Type: Syncfusion.OfficeChart.Implementation.Charts.HistogramAxisFormat
...
internal class HistogramAxisFormat
{
  ...
  internal double OverflowBinValue
  {
    ...
    set
    {
      ...
      this.IsAutomaticFlowValue = false;
    }
  }
  ...
  public override bool Equals(object obj)
  {
    ...
    return (int) this.m_flagOptions == (int) histogramAxisFormat.m_flagOptions && this.m_binWidth == histogramAxisFormat.m_binWidth && this.m_numberOfBins == histogramAxisFormat.m_numberOfBins && this.m_overflowBinValue == histogramAxisFormat.m_overflowBinValue && this.m_underflowBinValue == histogramAxisFormat.m_underflowBinValue;
  }
}
