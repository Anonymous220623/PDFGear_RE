...
// Type: Syncfusion.OfficeChart.Implementation.Charts.ChartAxisImpl
...
internal abstract class ChartAxisImpl : CommonObject, IOfficeChartAxis
{
  ...
  public int TextRotationAngle
  {
    get
    {
      return this.ParentWorkbook.Version == OfficeVersion.Excel97to2003 ? (int) this.m_chartTick.RotationAngle : (int) -this.m_chartTick.RotationAngle;
    }
    set
    {
      if (value == 0)
      ...
      {
        this.m_chartTick.RotationAngle = this.ParentWorkbook.Version != OfficeVersion.Excel97to2003 ? (short) -value : (short) value;
  ...
  public IOfficeChartTextArea TitleArea
  {
    get
    {
      ...
      return (IOfficeChartTextArea) this.m_titleArea;
    }
  }
  ...
  public IOfficeChartGridLine MajorGridLines => (IOfficeChartGridLine) this.m_majorGrid;

  public IOfficeChartGridLine MinorGridLines => (IOfficeChartGridLine) this.m_minorGrid;
  ...
  public string NumberFormat
  {
    ...
    set
    {
      switch (value)
      {
        ...
        default:
          if (!this.ParentWorkbook.IsLoaded && this.IsSourceLinked)
  ...
  public bool Visible
  {
    ...
    set
    {
      if (value == this.Visible)
        return;
      this.Border.LinePattern = value ? OfficeChartLinePattern.Solid : OfficeChartLinePattern.None;
      this.Deleted = !value;
    }
  }
  ...
  public IOfficeChartFrameFormat FrameFormat
  {
    get
    {
      ...
      return (IOfficeChartFrameFormat) this.m_axisFormat;
    }
  }
  ...
  {
    get => this.m_labelTextAlign;
    set => this.m_labelTextAlign = value;
  }
  ...
  protected void Parse(IList<BiffRecordRaw> data, ref int iPos, bool isPrimary)
  {
    ...
    switch (chartAxisRecord.AxisType)
    {
      case ChartAxisRecord.ChartAxisType.CategoryAxis:
        this.m_axisType = OfficeAxisType.Category;
        break;
      case ChartAxisRecord.ChartAxisType.ValueAxis:
        this.m_axisType = OfficeAxisType.Value;
        break;
      case ChartAxisRecord.ChartAxisType.SeriesAxis:
        this.m_axisType = OfficeAxisType.Serie;
        break;
    }
  }
  ...
  private void ParseTickRecord(ChartTickRecord chartTick)
  {
    ...
    this.m_textDirection = OfficeAxisTextDirection.Context;
    if (chartTick.IsLeftToRight)
    {
      this.m_textDirection = OfficeAxisTextDirection.LeftToRight;
    }
    else
    {
      if (!chartTick.IsRightToLeft)
        return;
      this.m_textDirection = OfficeAxisTextDirection.RightToLeft;
    }
  }
  ...
  protected void SerializeTickRecord(OffsetArrayList records)
  {
    ...
    if (this.Alignment == OfficeAxisTextDirection.LeftToRight)
      chartTickRecord.IsLeftToRight = true;
    else if (this.Alignment == OfficeAxisTextDirection.RightToLeft)
  ...
  private void InitializeTickRecord()
  {
    ...
    this.m_chartTick.MajorMark = OfficeTickMark.TickMark_Outside;
    this.m_chartTick.LabelPos = OfficeTickLabelPosition.TickLabelPosition_NextToAxis;
    ...
    Dictionary<string, string> dicNewSheetNames)
  {
    ...
    if (this.m_font != null)
    {
      ...
      Color rgbColor = this.m_font.RGBColor;
      parent1.m_font.RGBColor = this.m_font.RGBColor;
    }
    if (this.m_textStream != null)
    {
      byte[] buffer = new byte[this.m_textStream.Length];
      int count;
      while ((count = this.m_textStream.Read(buffer, 0, buffer.Length)) > 0)
        parent1.m_textStream.Write(buffer, 0, count);
    }
    if (this.m_shadow != null)
      parent1.m_shadow = this.m_shadow.Clone((object) parent1);
    parent1.m_textDirection = this.m_textDirection;
    parent1.m_paraType = this.m_paraType;
    if (this.m_axisPos.HasValue)
      parent1.m_axisPos = this.m_axisPos;
    return parent1;
  }
  ...
  public ChartAxisImpl Clone(FontWrapper font)
  {
    ...
    parent.Font = (IOfficeFont) font.Clone((object) parent);
    return parent;
  }

  public void SetTitle(ChartTextAreaImpl text) => this.m_titleArea = text;

  public void UpdateTickRecord(OfficeTickLabelPosition value) => this.m_chartTick.LabelPos = value;
  ...
  protected void InitFrameFormat()
  {
    ...
    this.m_axisFormat.Border.LinePattern = OfficeChartLinePattern.None;
    this.m_axisFormat.Border.AutoFormat = false;
    this.m_axisFormat.Interior.UseAutomaticFormat = false;
    this.m_axisFormat.Interior.Pattern = OfficePattern.None;
  }
  ...
  {
    this.m_border = border as ChartBorderImpl;
  }
