...
// Type: Syncfusion.OfficeChart.Implementation.Charts.ChartFillImpl
...
internal class ChartFillImpl : ShapeFillImpl
{
  ...
  private void Parse()
  {
    ...
    if (this.ParsePictureData == null)
      return;
    this.ParsePictureOrUserDefinedTexture(this.m_fillType == OfficeFillType.Picture);
  }
  ...
  public override ChartColor ForeColorObject => (this.Parent as IFillColor).ForeGroundColorObject;

  public override ChartColor BackColorObject => (this.Parent as IFillColor).BackGroundColorObject;

  public override bool Visible
  {
    get => (this.Parent as IFillColor).Pattern != OfficePattern.None;
    set
    {
      ...
      if (value)
      {
        if (parent.Pattern != OfficePattern.None)
          return;
        parent.Pattern = OfficePattern.Solid;
      }
      else
        parent.Pattern = OfficePattern.None;
    }
  }
