...
// Type: Syncfusion.OfficeChart.Implementation.Charts.ChartParentAxisImpl
...
internal class ChartParentAxisImpl : CommonObject
{
    ...
    : base(application, parent)
  {
    ...
    if (isPrimary)
    {
      this.m_categoryAxis = new ChartCategoryAxisImpl(application, (object) this, OfficeAxisType.Category, this.IsPrimary);
      this.m_valueAxis = new ChartValueAxisImpl(application, (object) this, OfficeAxisType.Value, this.IsPrimary);
    }
    if (!this.IsPrimary)
    ...
    while (num != 0)
    {
      ...
      switch (biffRecordRaw.TypeCode)
      {
        ...
        case TBIFFRecord.ChartPlotArea:
          this.m_parentChart.PlotArea = (IOfficeChartFrameFormat) new ChartPlotAreaImpl(this.Application, (object) this.m_parentChart, data, ref iPos);
          break;
  ...
  public void Serialize(OffsetArrayList records)
  {
    ...
    if (this.m_parentAxis == null)
      return;
    bool flag = Array.IndexOf<OfficeChartType>(ChartImpl.DEF_SUPPORT_SERIES_AXIS, this.m_parentChart.ChartType) != -1;
  ...
  public void CreatePrimaryFormats()
  {
    ...
    if (this.m_parentChart.ParentWorkbook.IsWorkbookOpening)
      return;
  ...
  public void UpdateSecondaryAxis(bool bCreateAxis)
  {
    ...
    if (this.m_categoryAxis == null)
    {
      this.m_categoryAxis = new ChartCategoryAxisImpl(this.Application, (object) this, OfficeAxisType.Category, false);
      this.m_categoryAxis.IsMaxCross = true;
    }
    if (this.m_valueAxis != null)
      return;
    this.m_valueAxis = new ChartValueAxisImpl(this.Application, (object) this, OfficeAxisType.Value, false);
  }
