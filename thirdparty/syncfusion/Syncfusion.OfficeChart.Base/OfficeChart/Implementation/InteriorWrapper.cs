...
// Type: Syncfusion.OfficeChart.Implementation.InteriorWrapper
...
internal class InteriorWrapper : CommonWrapper, IInterior, IOptimizedUpdate
{
  ...
  public OfficeKnownColors PatternColorIndex
  {
    ...
    set
    {
      ...
      if (this.m_gradient != null)
        this.FillPattern = OfficePattern.Solid;
  ...
  public OfficePattern FillPattern
  {
    ...
    set
    {
      if (this.m_xFormat.Workbook.Version == OfficeVersion.Excel97to2003 && value == OfficePattern.Gradient)
  ...
  private void CreateGradientWrapper()
  {
    ...
    if (gradient == null)
    {
      ...
      gradient.FillType = OfficeFillType.Gradient;
    }
