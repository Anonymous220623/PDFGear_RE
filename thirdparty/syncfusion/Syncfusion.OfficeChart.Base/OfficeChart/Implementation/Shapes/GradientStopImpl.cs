...
// Type: Syncfusion.OfficeChart.Implementation.Shapes.GradientStopImpl
...
internal class GradientStopImpl
{
  ...
  public int Position
  {
    ...
    set => this.m_iPosiiton = value;
  }

  public int Transparency
  {
    get => this.m_iTransparency;
    set => this.m_iTransparency = value;
  }

  public int Tint
  {
    get => this.m_iTint;
    set => this.m_iTint = value;
  }

  public int Shade
  {
    get => this.m_iShade;
    set => this.m_iShade = value;
  }
  ...
  public GradientStopImpl(byte[] data, int offset)
  {
    ...
    offset += 4;
    this.m_color = new ChartColor(ColorExtension.FromArgb(BitConverter.ToInt32(data, offset)));
    offset += 4;
  ...
  internal GradientStopImpl Clone()
  {
    ...
    gradientStopImpl.m_color = new ChartColor(OfficeKnownColors.Black);
