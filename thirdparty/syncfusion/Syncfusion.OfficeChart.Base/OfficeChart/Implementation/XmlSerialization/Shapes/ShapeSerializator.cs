...
// Type: Syncfusion.OfficeChart.Implementation.XmlSerialization.Shapes.ShapeSerializator
...
internal abstract class ShapeSerializator
{
  ...
  protected virtual void SerializeSolidFill(XmlWriter writer, TextBoxShapeBase textBox)
  {
    ...
    {
      if (textBox.ColorObject == (ChartColor) null)
        return;
    ...
    RelationCollection relations)
  {
    ...
    {
      writer.WriteAttributeString("dashstyle", this.GetDashStyle(textBox.Line.DashStyle));
  ...
  protected string GetPresetString(OfficeGradientPreset OfficeGradientPreset) => (string) null;
  ...
  protected string GetDashStyle(OfficeShapeDashLineStyle dashStyle)
  {
    ...
    IEnumerator<OfficeShapeDashLineStyle> enumerator2 = (IEnumerator<OfficeShapeDashLineStyle>) excelDashLineStyle.Values.GetEnumerator();
  ...
  protected string GetLineStyle(OfficeShapeLineStyle lineStyle)
  {
    ...
    IEnumerator<OfficeShapeLineStyle> enumerator2 = (IEnumerator<OfficeShapeLineStyle>) excelShapeLineStyle.Values.GetEnumerator();
    while (enumerator1.MoveNext())
    {
      enumerator2.MoveNext();
