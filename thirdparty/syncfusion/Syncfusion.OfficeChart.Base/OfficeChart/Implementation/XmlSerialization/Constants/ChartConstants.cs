...
// Type: Syncfusion.OfficeChart.Implementation.XmlSerialization.Constants.ChartConstants
...
internal sealed class ChartConstants
{
  internal const string ColorMapOverrideTag = "clrMapOvr";
  internal const string ChartStyleNamespace = "http://schemas.microsoft.com/office/drawing/2012/chartStyle";
  public const string RNamespace = "http://schemas.openxmlformats.org/officeDocument/2006/relationships";
  ...
  internal const string ShowDataLabelsRangeTag = "showDataLabelsRange";
  internal const string DataLabelsRangeTag = "datalabelsRange";
  internal const string DataLabelRangeCacheTag = "dlblRangeCache";
  ...
  internal const string CellRangeTag = "[CELLRANGE]";
  internal const string SeriesNameTag = "[SERIES NAME]";
  internal const string ValueTag = "[VALUE]";
  internal const string CategoryNameTag = "[CATEGORY NAME]";
  internal const string PercentageTag = "[PERCENTAGE]";
  internal const string CatetoryXaxisTag = "[X VALUE]";
  internal const string ValueYaxisTag = "[Y VALUE]";
  ...
  internal const string ExtentionList = "extLst";
  ...
  public const double CoordinatesMultiplyer = 1000.0;
  ...
  public const string ExternalData = "externalData";
  ...
  internal const int EmusPerPoint = 12700;
  ...
  internal const string InvertSolidFillFmtUri = "{6F2FDCE9-48DA-4B69-8628-5D25D57E5C99}";
  internal const string c14tag = "c14";
  internal const string xml14web = "http://schemas.microsoft.com/office/drawing/2007/8/2/chart";
  internal const string LeaderLines = "leaderLines";
