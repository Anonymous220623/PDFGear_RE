...
// Type: Syncfusion.OfficeChart.Implementation.WorksheetHelper
...
internal class WorksheetHelper
{
  ...
  public static RowStorage GetOrCreateRow(IInternalWorksheet sheet, int rowIndex, bool bCreate)
  {
    ...
    int heightInRowUnits = ((sheet.Workbook as WorkbookImpl).Application as ApplicationImpl).StandardHeightInRowUnits;
