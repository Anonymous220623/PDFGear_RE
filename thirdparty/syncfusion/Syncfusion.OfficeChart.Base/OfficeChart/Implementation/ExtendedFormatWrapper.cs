...
// Type: Syncfusion.OfficeChart.Implementation.ExtendedFormatWrapper
...
internal class ExtendedFormatWrapper : 
  CommonWrapper,
  ...
  ICloneParent
{
  ...
  public void ChangeFillPattern()
  {
    ...
    {
      case OfficePattern.None:
      case OfficePattern.Gradient:
        this.m_xFormat.FillPattern = OfficePattern.Solid;
  ...
  {
    if (this.m_xFormat != null && this.m_xFormat.Index == index)
      return;
    this.m_xFormat = this.m_book.InnerExtFormats[index];
    if (this.m_book.InnerFonts.Count <= this.m_xFormat.FontIndex)
      this.m_xFormat.FontIndex = 0;
    FontImpl innerFont = this.m_book.InnerFonts[this.m_xFormat.FontIndex] as FontImpl;
    if (this.m_font == null)
    {
  ...
  public bool IsFirstSymbolApostrophe
  {
    ...
    set
    {
      if (this.IsFirstSymbolApostrophe == value)
        return;
      if (!this.m_book.IsLoaded && !this.m_book.IsWorkbookOpening)
        this.BeginUpdate();
  ...
  public OfficeKnownColors PatternColorIndex
  {
    ...
    set
    {
      if (this.PatternColorIndex == value && this.FillPattern != OfficePattern.Gradient)
        return;
      this.BeginUpdate();
  ...
  public Color PatternColor
  {
    ...
    set
    {
      if (!(this.PatternColor != value) && this.PatternColorIndex != OfficeKnownColors.BlackCustom)
        return;
      this.BeginUpdate();
  ...
  public OfficeKnownColors ColorIndex
  {
    ...
    set
    {
      if (this.FillPattern != OfficePattern.Gradient && this.ColorIndex == value)
        return;
      this.BeginUpdate();
  ...
  public Color Color
  {
    ...
    set
    {
      if (!(this.Color != value) && this.ColorIndex != (OfficeKnownColors.White | OfficeKnownColors.BlackCustom))
        return;
      this.BeginUpdate();
  ...
  public OfficeLineStyle DiagonalUpBorderLineStyle
  {
    ...
    set
    {
      ...
      if (!this.m_xFormat.DiagonalUpVisible && value != OfficeLineStyle.None)
      {
        if (!flag)
          this.BeginUpdate();
