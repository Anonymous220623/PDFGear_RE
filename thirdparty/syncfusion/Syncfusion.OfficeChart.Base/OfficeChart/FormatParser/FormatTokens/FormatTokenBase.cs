...
// Type: Syncfusion.OfficeChart.FormatParser.FormatTokens.FormatTokenBase
...
{
  protected internal const RegexOptions DEF_OPTIONS = RegexOptions.Compiled;
  ...
  protected int TryParseRegex(Regex regex, string strFormat, int iIndex, out Match m)
  {
    ...
    if (iIndex < 0 || iIndex > num - 1)
      throw new ArgumentOutOfRangeException(nameof (iIndex), "Value cannot be less than 0 or greater than Format Length - 1");
