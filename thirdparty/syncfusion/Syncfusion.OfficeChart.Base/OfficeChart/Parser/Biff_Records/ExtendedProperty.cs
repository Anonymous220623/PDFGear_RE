...
// Type: Syncfusion.OfficeChart.Parser.Biff_Records.ExtendedProperty
...
internal class ExtendedProperty
{
  ...
  private List<Syncfusion.OfficeChart.Parser.Biff_Records.GradStops> m_gradstops;
  ...
  public List<Syncfusion.OfficeChart.Parser.Biff_Records.GradStops> GradStops
  {
    get => this.m_gradstops;
    set => this.m_gradstops = value;
  }

  public ExtendedProperty() => this.m_gradstops = new List<Syncfusion.OfficeChart.Parser.Biff_Records.GradStops>();
  ...
  public int ParseGradient(DataProvider provider, int iOffset, OfficeVersion version)
  {
    ...
    {
      Syncfusion.OfficeChart.Parser.Biff_Records.GradStops gradStops = new Syncfusion.OfficeChart.Parser.Biff_Records.GradStops();
  ...
  public int SerializeGradient(DataProvider provider, int iOffset, OfficeVersion version)
  {
    ...
    iOffset += 4;
    foreach (Syncfusion.OfficeChart.Parser.Biff_Records.GradStops gradStop in this.GradStops)
