...
// Type: Syncfusion.OfficeChart.Parser.Biff_Records.BiffRecordRawWithDataProvider
...
internal abstract class BiffRecordRawWithDataProvider : BiffRecordRaw, IDisposable
{
  ...
  public override object Clone()
  {
    ...
    withDataProvider.m_provider = zero != IntPtr.Zero ? ApplicationImpl.CreateDataProvider(zero) : ApplicationImpl.CreateDataProvider();
