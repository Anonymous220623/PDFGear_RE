...
// Type: Syncfusion.OfficeChart.Parser.Biff_Records.Charts.ChartAreaFormatRecord
...
internal class ChartAreaFormatRecord : BiffRecordRaw
{
  ...
  {
    get => (OfficePattern) this.m_usPattern;
  ...
  {
    get => (OfficeKnownColors) this.m_usForegroundIndex;
    set
    {
  ...
  {
    get => (OfficeKnownColors) this.m_usBackgroundIndex;
    set
    {
      ushort num = (ushort) value;
