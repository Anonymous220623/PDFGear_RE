...
// Type: Syncfusion.OfficeChart.Parser.Biff_Records.Charts.ChartAIRecord
...
internal class ChartAIRecord : BiffRecordRaw
{
    ...
    OfficeVersion version)
  {
    ...
    this.m_bCustomNumberFormat = provider.ReadBit(iOffset, 1);
    iOffset += 2;
    ...
    OfficeVersion version)
  {
    ...
    provider.WriteBit(iOffset, this.m_bCustomNumberFormat, 1);
    iOffset += 2;
