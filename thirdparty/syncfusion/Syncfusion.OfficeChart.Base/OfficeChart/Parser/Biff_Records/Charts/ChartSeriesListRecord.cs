...
// Type: Syncfusion.OfficeChart.Parser.Biff_Records.Charts.ChartSeriesListRecord
...
internal class ChartSeriesListRecord : BiffRecordRaw
{
  ...
  public override int GetStoreSize(OfficeVersion version) => 2 + 2 * (int) this.m_usCount;
