...
// Type: Syncfusion.OfficeChart.Parser.Biff_Records.Charts.ChartTickRecord
...
internal class ChartTickRecord : BiffRecordRaw
{
    ...
    OfficeVersion version)
  {
    ...
    ++iOffset;
    provider.WriteUInt32(iOffset, this.m_uiTextColor);
    iOffset += 4;
    iOffset += 16 /*0x10*/;
  ...
  public override int GetStoreSize(OfficeVersion version) => 30;
}
