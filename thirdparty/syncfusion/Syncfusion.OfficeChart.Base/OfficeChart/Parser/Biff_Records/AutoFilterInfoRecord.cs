...
// Type: Syncfusion.OfficeChart.Parser.Biff_Records.AutoFilterInfoRecord
...
internal class AutoFilterInfoRecord : BiffRecordRaw
{
  ...
  {
    get => this.m_usArrowsCount;
    set => this.m_usArrowsCount = value;
  }
  ...
  {
    this.m_usArrowsCount = provider.ReadUInt16(iOffset);
  }
  ...
  public override void InfillInternalData(
    ...
    OfficeVersion version)
  {
    provider.WriteUInt16(iOffset, this.m_usArrowsCount);
    this.m_iLength = 2;
  }
}
