...
// Type: Syncfusion.OfficeChart.Parser.Biff_Records.PrintSetupRecord
...
internal class PrintSetupRecord : BiffRecordRaw
{
  ...
  public OfficePrintErrors PrintErrors
  {
    get
    {
      return (OfficePrintErrors) ((int) BiffRecordRaw.GetUInt16BitsByMask(this.m_usOptions, (ushort) 3072 /*0x0C00*/) >> 10);
    }
    set
    {
  ...
  public override int GetStoreSize(OfficeVersion version) => 34;
}
