...
// Type: Syncfusion.OfficeChart.Parser.Biff_Records.ArrayRecord
...
internal class ArrayRecord : BiffRecordRaw, ISharedFormula, ICloneable, IFormulaRecord
{
  ...
  public Ptg[] Formula
  {
    ...
    {
      int formulaLen;
      this.m_arrExpression = value != null ? FormulaUtil.PtgArrayToByteArray(value, out formulaLen, OfficeVersion.Excel2007) : throw new ArgumentNullException(nameof (Formula));
