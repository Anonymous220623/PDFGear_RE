...
// Type: Syncfusion.OfficeChart.Parser.Biff_Records.TextObjectRecord
...
internal class TextObjectRecord : BiffRecordRawWithArray
{
  ...
  public OfficeCommentHAlign HAlignment
  {
    get
    {
      return (OfficeCommentHAlign) ((int) BiffRecordRaw.GetUInt16BitsByMask(this.m_usOptions, (ushort) 14) >> 1);
    }
    set
    {
  ...
  public OfficeCommentVAlign VAlignment
  {
    get
    {
      return (OfficeCommentVAlign) ((int) BiffRecordRaw.GetUInt16BitsByMask(this.m_usOptions, (ushort) 112 /*0x70*/) >> 4);
    }
    set
    {
  ...
  {
    get => (OfficeTextRotation) this.m_usRotation;
