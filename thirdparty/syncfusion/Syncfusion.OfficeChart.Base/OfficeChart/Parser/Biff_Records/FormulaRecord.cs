...
// Type: Syncfusion.OfficeChart.Parser.Biff_Records.FormulaRecord
  ...
  IFormulaRecord
{
  ...
  public Ptg[] ParsedExpression
  {
    ...
    set
    {
      ...
      {
        int formulaLen;
        this.m_expression = FormulaUtil.PtgArrayToByteArray(value, out formulaLen, OfficeVersion.Excel2007);
    ...
    bool bFromExcel07To97)
  {
    ...
    ushort num2 = 0;
    OfficeVersion version1;
    OfficeVersion version2;
    if (bFromExcel07To97)
    {
      version1 = OfficeVersion.Excel2007;
      version2 = OfficeVersion.Excel97to2003;
    }
    else
    {
      version1 = OfficeVersion.Excel97to2003;
