...
public static class SvgQRCodeHelper
{
    ...
    SvgQRCode.SvgLogo logo = null)
  {
    using (QRCodeGenerator qrCodeGenerator = new QRCodeGenerator())
    {
      ...
      {
        using (SvgQRCode svgQrCode = new SvgQRCode(qrCode))
          return svgQrCode.GetGraphic(pixelsPerModule, darkColorHex, lightColorHex, drawQuietZones, sizingMode, logo);
      }
    }
  }
}
