...
// Type: QRCoder.PostscriptQRCodeHelper
...
public static class PostscriptQRCodeHelper
{
    ...
    bool epsFormat = false)
  {
    using (QRCodeGenerator qrCodeGenerator = new QRCodeGenerator())
    {
      ...
      {
        using (PostscriptQRCode postscriptQrCode = new PostscriptQRCode(qrCode))
          return postscriptQrCode.GetGraphic(pointsPerModule, darkColorHex, lightColorHex, drawQuietZones, epsFormat);
      }
    }
  }
}
