...
// Type: Patagames.Pdf.Net.AcroForms.PdfRadioButtonControl
...
/// <summary>
/// Represents a widget annotations that are associated with <see cref="T:Patagames.Pdf.Net.AcroForms.PdfRadioButtonField" /> fields.
/// </summary>
public class PdfRadioButtonControl : PdfControl
{
  ...
  /// <summary>Gets whether the Radiobutton is checked.</summary>
  /// <exception cref="T:Patagames.Pdf.Net.Exceptions.DomException">Thrown by newly created Controls that have not yet been added to the DOM.</exception>
  ...
  /// <summary>Get a default state of the Radiobutton.</summary>
  /// <exception cref="T:Patagames.Pdf.Net.Exceptions.DomException">Thrown by newly created Controls that have not yet been added to the DOM.</exception>
  ...
  /// <summary>
  /// Initializes a new instance of the <see cref="T:Patagames.Pdf.Net.AcroForms.PdfRadioButtonControl" /> class.
  /// </summary>
  /// <param name="forms">Interactive forms.</param>
  /// <param name="handle">The control's handle.</param>
  internal PdfRadioButtonControl(PdfInteractiveForms forms, IntPtr handle)
    : base(forms, handle)
  {
  }

  /// <summary>
  /// Create a new radiobutton control and assign it to the specified <paramref name="field" />.
  /// </summary>
  ...
  {
    PdfRadioButtonField field1 = field;
    PdfPage page1 = page;
    FS_RECTF rect1 = rect;
  ...
  public bool Check(bool check)
  {
    ...
    return index >= 0 && (this.Field as PdfRadioButtonField).Check(index, check);
  }
}
