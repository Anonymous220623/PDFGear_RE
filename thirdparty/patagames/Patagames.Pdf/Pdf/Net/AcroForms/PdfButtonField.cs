...
// Type: Patagames.Pdf.Net.AcroForms.PdfButtonField
...
{
  /// <summary>
  /// Initializes a new instance of the <see cref="T:Patagames.Pdf.Net.AcroForms.PdfButtonField" /> class.
  /// </summary>
  /// <param name="forms">Interactive forms.</param>
  /// <param name="handle">The field's handle.</param>
  internal PdfButtonField(PdfInteractiveForms forms, IntPtr handle)
    : base(forms, handle)
  {
  }

  /// <summary>The base constructor for creating new button field</summary>
  /// <param name="forms">Interactive forms.</param>
  ...
  {
    this.Dictionary["FT"] = (PdfTypeBase) PdfTypeName.Create("Btn");
  }
}
