...
// Type: Patagames.Pdf.Net.AcroForms.PdfListBoxControl
...
/// <summary>
/// Represents a widget annotations that are associated with <see cref="T:Patagames.Pdf.Net.AcroForms.PdfListBoxField" /> fields.
/// </summary>
public class PdfListBoxControl : PdfControl
{
  ...
  public JustifyTypes Alignment
  {
    get
    {
      ...
      return this.Field != null ? (this.Field as PdfListBoxField).Alignment : JustifyTypes.Left;
    }
    set
    {
  ...
  /// <summary>
  /// Initializes a new instance of the <see cref="T:Patagames.Pdf.Net.AcroForms.PdfListBoxControl" /> class.
  /// </summary>
  /// <param name="forms">Interactive forms.</param>
  /// <param name="handle">The control's handle.</param>
  internal PdfListBoxControl(PdfInteractiveForms forms, IntPtr handle)
    : base(forms, handle)
  {
  }

  /// <summary>
  /// Create a new listbox control and assign it to the specified <paramref name="field" />.
  /// </summary>
  ...
  public PdfListBoxControl(
    PdfListBoxField field,
    PdfPage page,
    FS_RECTF rect,
