...
// Type: Patagames.Pdf.Net.Annotations.PdfUnderlineAnnotation
...
/// <summary>Represents the underline annotation</summary>
/// <remarks>
...
public class PdfUnderlineAnnotation : PdfTextMarkupAnnotation
{
  ...
  public PdfUnderlineAnnotation(PdfPage page)
    : base(page)
  {
    this.Dictionary["Subtype"] = (PdfTypeBase) PdfTypeName.Create("Underline");
  }
  ...
  public PdfUnderlineAnnotation(PdfPage page, PdfTypeBase dictionary)
