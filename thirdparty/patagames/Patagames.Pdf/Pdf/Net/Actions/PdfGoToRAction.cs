...
// Type: Patagames.Pdf.Net.Actions.PdfGoToRAction
...
public class PdfGoToRAction : PdfAction
{
  ...
  /// <summary>
  /// Initializes a new instance of the <see cref="T:Patagames.Pdf.Net.Actions.PdfGoToRAction" /> class with the document, file specification and the destination.
  /// </summary>
    ...
    : base(document, PdfTypeDictionary.Create().Handle)
  {
    ...
    this.Dictionary["S"] = (PdfTypeBase) PdfTypeName.Create("GoToR");
  ...
  public PdfGoToRAction(PdfDocument document, IntPtr handle)
