...
// Type: Patagames.Pdf.Net.Exceptions.EntryNotFoundException
...
public class EntryNotFoundException(string entryName) : PdfiumException(11U, string.Format(Error.err0044, (object) entryName))
{
}
