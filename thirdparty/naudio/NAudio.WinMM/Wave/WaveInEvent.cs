...
public class WaveInEvent : IWaveIn, IDisposable
{
  ...
  public WaveInEvent()
  {
    ...
    this.DeviceNumber = 0;
    this.WaveFormat = new WaveFormat(8000, 16 /*0x10*/, 1);
  ...
  public long GetPosition()
  {
    ...
    mmTime.wType = 4U;
    MmException.Try(WaveInterop.waveInGetPosition(this.waveInHandle, out mmTime, Marshal.SizeOf<MmTime>(mmTime)), "waveInGetPosition");
    return mmTime.wType == 4U ? (long) mmTime.cb : throw new Exception($"waveInGetPosition: wType -> Expected {4}, Received {mmTime.wType}");
  }
