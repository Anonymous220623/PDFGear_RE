...
internal class Stereo24SampleChunkConverter : ISampleChunkConverter
{
  ...
  public bool GetNextSample(out float sampleLeft, out float sampleRight)
  {
    ...
    {
      sampleLeft = (float) ((int) (sbyte) this.sourceBuffer[this.offset + 2] << 16 /*0x10*/ | (int) this.sourceBuffer[this.offset + 1] << 8 | (int) this.sourceBuffer[this.offset]) / 8388608f;
      this.offset += 3;
      sampleRight = (float) ((int) (sbyte) this.sourceBuffer[this.offset + 2] << 16 /*0x10*/ | (int) this.sourceBuffer[this.offset + 1] << 8 | (int) this.sourceBuffer[this.offset]) / 8388608f;
      this.offset += 3;
      return true;
    }
    sampleLeft = 0.0f;
