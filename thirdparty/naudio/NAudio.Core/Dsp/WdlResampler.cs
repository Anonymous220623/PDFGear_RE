...
public class WdlResampler
{
  ...
  private const int WDL_RESAMPLE_MAX_NCH = 64 /*0x40*/;
  ...
  public void SetMode(bool interp, int filtercnt, bool sinc, int sinc_size = 64 /*0x40*/, int sinc_interpsize = 32 /*0x20*/)
  {
    this.m_sincsize = !sinc || sinc_size < 4 ? 0 : (sinc_size > 8192 /*0x2000*/ ? 8192 /*0x2000*/ : sinc_size);
    this.m_sincoversize = this.m_sincsize != 0 ? (sinc_interpsize <= 1 ? 1 : (sinc_interpsize >= 4096 /*0x1000*/ ? 4096 /*0x1000*/ : sinc_interpsize)) : 1;
...
label_13:
  ...
  private class WDL_Resampler_IIRFilter
  {
    ...
    public void Reset() => this.m_hist = new double[256 /*0x0100*/, 4];
