...
public abstract class JsonWriter : IDisposable
{
  ...
  internal static readonly JsonWriter.State[][] StateArrayTemplate = new JsonWriter.State[8][]
  {
  ...
  {
    return this.WriteTokenAsync(token, (object) null, cancellationToken);
  }
...
label_43:
  ...
  {
    List<JsonWriter.State[]> list = ((IEnumerable<JsonWriter.State[]>) JsonWriter.StateArrayTemplate).ToList<JsonWriter.State[]>();
    JsonWriter.State[] stateArray1 = JsonWriter.StateArrayTemplate[0];
    JsonWriter.State[] stateArray2 = JsonWriter.StateArrayTemplate[7];
