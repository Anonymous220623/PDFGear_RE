...
{
  private const int MaxCharBytesSize = 128 /*0x80*/;
  ...
  private string ReadString()
  {
    ...
    while (true)
    {
      int num2 = length;
      byte num3;
      while (num2 < 128 /*0x80*/ && (num3 = this._reader.ReadByte()) > (byte) 0)
        this._byteBuffer[num2++] = num3;
      byteCount = num2 - length;
      num1 += byteCount;
      if (num2 >= 128 /*0x80*/ || stringBuilder != null)
      {
...
label_11:
  ...
  private string GetString(int length)
  {
    ...
    do
    {
      int count = length - num1 > 128 /*0x80*/ - num2 ? 128 /*0x80*/ - num2 : length - num1;
...
label_5:
  ...
  private void EnsureBuffers()
  {
    if (this._byteBuffer == null)
      this._byteBuffer = new byte[128 /*0x80*/];
    if (this._charBuffer != null)
      return;
    this._charBuffer = new char[Encoding.UTF8.GetMaxCharCount(128 /*0x80*/)];
  }
