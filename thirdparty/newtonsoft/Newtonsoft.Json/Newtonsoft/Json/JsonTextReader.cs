  ...
  private void ParseReadNumber(ReadType readType, char firstChar, int initialPosition)
  {
    ...
    switch (readType)
    {
      ...
      case ReadType.ReadAsInt64:
        if (flag1)
        {
          obj = (object) ((long) firstChar - 48L /*0x30*/);
        ...
        if (flag2)
        {
          ...
          try
          {
            obj = (object) (str.StartsWith("0x", StringComparison.OrdinalIgnoreCase) ? Convert.ToInt64(str, 16 /*0x10*/) : Convert.ToInt64(str, 8));
          }
          catch (Exception ex)
          {
      ...
      case ReadType.ReadAsInt32:
        if (flag1)
          obj = (object) ((int) firstChar - 48 /*0x30*/);
        else if (flag2)
        {
          string str = this._stringReference.ToString();
          try
          {
            obj = (object) (str.StartsWith("0x", StringComparison.OrdinalIgnoreCase) ? Convert.ToInt32(str, 16 /*0x10*/) : Convert.ToInt32(str, 8));
          }
          catch (Exception ex)
          {
      ...
      case ReadType.ReadAsDecimal:
        ...
        else if (flag2)
        {
          ...
          try
          {
            obj = (object) Convert.ToDecimal(str.StartsWith("0x", StringComparison.OrdinalIgnoreCase) ? Convert.ToInt64(str, 16 /*0x10*/) : Convert.ToInt64(str, 8));
          }
          catch (Exception ex)
          {
      ...
      case ReadType.ReadAsDouble:
        ...
        else if (flag2)
        {
          ...
          try
          {
            obj = (object) Convert.ToDouble(str.StartsWith("0x", StringComparison.OrdinalIgnoreCase) ? Convert.ToInt64(str, 16 /*0x10*/) : Convert.ToInt64(str, 8));
          }
          catch (Exception ex)
          {
