...
public class JsonTextWriter : JsonWriter
{
  ...
  {
    return !this._safeAsync ? base.FlushAsync(cancellationToken) : this.DoFlushAsync(cancellationToken);
  }
  ...
  {
    return !this._safeAsync ? base.WriteValueDelimiterAsync(cancellationToken) : this.DoWriteValueDelimiterAsync(cancellationToken);
  }
  ...
  {
    return !this._safeAsync ? base.WriteEndAsync(token, cancellationToken) : this.DoWriteEndAsync(token, cancellationToken);
  }
  ...
  {
    return !this._safeAsync ? base.CloseAsync(cancellationToken) : this.DoCloseAsync(cancellationToken);
  }
  ...
  {
    return !this._safeAsync ? base.WriteEndAsync(cancellationToken) : this.WriteEndInternalAsync(cancellationToken);
  }

  protected override Task WriteIndentAsync(CancellationToken cancellationToken)
  {
    return !this._safeAsync ? base.WriteIndentAsync(cancellationToken) : this.DoWriteIndentAsync(cancellationToken);
  }
  ...
  {
    return !this._safeAsync ? base.WriteIndentSpaceAsync(cancellationToken) : this.DoWriteIndentSpaceAsync(cancellationToken);
  }
  ...
  {
    return !this._safeAsync ? base.WriteRawAsync(json, cancellationToken) : this.DoWriteRawAsync(json, cancellationToken);
  }
  ...
  {
    return !this._safeAsync ? base.WriteNullAsync(cancellationToken) : this.DoWriteNullAsync(cancellationToken);
  }
  ...
  {
    return uvalue <= 9UL & !negative ? this._writer.WriteAsync((char) (48UL /*0x30*/ + uvalue), cancellationToken) : this._writer.WriteAsync(this._writeBuffer, 0, this.WriteNumberToBuffer(uvalue, negative), cancellationToken);
  }
  ...
  {
    return !this._safeAsync ? base.WriteStartArrayAsync(cancellationToken) : this.DoWriteStartArrayAsync(cancellationToken);
  }
  ...
  {
    return !this._safeAsync ? base.WriteStartObjectAsync(cancellationToken) : this.DoWriteStartObjectAsync(cancellationToken);
  }
  ...
  {
    return !this._safeAsync ? base.WriteUndefinedAsync(cancellationToken) : this.DoWriteUndefinedAsync(cancellationToken);
  }
  ...
  {
    return !this._safeAsync ? base.WriteWhitespaceAsync(ws, cancellationToken) : this.DoWriteWhitespaceAsync(ws, cancellationToken);
  }
  ...
  internal Task DoWriteValueAsync(bool? value, CancellationToken cancellationToken)
  {
    return value.HasValue ? this.DoWriteValueAsync(value.GetValueOrDefault(), cancellationToken) : this.DoWriteNullAsync(cancellationToken);
  }

  public override Task WriteValueAsync(byte value, CancellationToken cancellationToken = default (CancellationToken))
  {
    return !this._safeAsync ? base.WriteValueAsync(value, cancellationToken) : this.WriteIntegerValueAsync((long) value, cancellationToken);
  }
  ...
  {
    return value.HasValue ? this.WriteIntegerValueAsync((long) value.GetValueOrDefault(), cancellationToken) : this.DoWriteNullAsync(cancellationToken);
  }
  ...
  {
    return !this._safeAsync ? base.WriteValueAsync(value, cancellationToken) : this.WriteValueAsync(value, false, cancellationToken);
  }
  ...
  {
    return !this._safeAsync ? base.WriteValueAsync(value, cancellationToken) : this.WriteIntegerValueAsync(value, cancellationToken);
  }
  ...
  {
    return value.HasValue ? this.WriteIntegerValueAsync(value.GetValueOrDefault(), cancellationToken) : this.DoWriteNullAsync(cancellationToken);
  }

  internal Task WriteValueAsync(BigInteger value, CancellationToken cancellationToken)
  {
    return this.WriteValueInternalAsync(JsonToken.Integer, value.ToString((IFormatProvider) CultureInfo.InvariantCulture), cancellationToken);
  }
  ...
  {
    return !this._safeAsync ? base.WriteCommentAsync(text, cancellationToken) : this.DoWriteCommentAsync(text, cancellationToken);
  }
  ...
  {
    return !this._safeAsync ? base.WriteEndArrayAsync(cancellationToken) : this.InternalWriteEndAsync(JsonContainerType.Array, cancellationToken);
  }

  public override Task WriteEndConstructorAsync(CancellationToken cancellationToken = default (CancellationToken))
  {
    return !this._safeAsync ? base.WriteEndConstructorAsync(cancellationToken) : this.InternalWriteEndAsync(JsonContainerType.Constructor, cancellationToken);
  }

  public override Task WriteEndObjectAsync(CancellationToken cancellationToken = default (CancellationToken))
  {
    return !this._safeAsync ? base.WriteEndObjectAsync(cancellationToken) : this.InternalWriteEndAsync(JsonContainerType.Object, cancellationToken);
  }

  public override Task WriteRawValueAsync(string? json, CancellationToken cancellationToken = default (CancellationToken))
  {
    return !this._safeAsync ? base.WriteRawValueAsync(json, cancellationToken) : this.DoWriteRawValueAsync(json, cancellationToken);
  }
  ...
  private void WriteIntegerValue(long value)
  {
    ...
    {
      this._writer.Write((char) (48UL /*0x30*/ + (ulong) value));
    }
    else
    {
      bool negative = value < 0L;
  ...
  private void WriteIntegerValue(ulong value, bool negative)
  {
    if (!negative & value <= 9UL)
      this._writer.Write((char) (48UL /*0x30*/ + value));
    else
  ...
  private int WriteNumberToBuffer(ulong value, bool negative)
  {
    ...
    do
    {
      ...
      this._writeBuffer[--num1] = (char) (48UL /*0x30*/ + num3);
      value = num2;
    }
    while (value != 0UL);
    return buffer;
  ...
  private void WriteIntegerValue(int value)
  {
    if (value >= 0 && value <= 9)
    {
      this._writer.Write((char) (48 /*0x30*/ + value));
    }
    else
    {
  ...
  private void WriteIntegerValue(uint value, bool negative)
  {
    if (!negative & value <= 9U)
      this._writer.Write((char) (48U /*0x30*/ + value));
    else
      this._writer.Write(this._writeBuffer, 0, this.WriteNumberToBuffer(value, negative));
  }
  ...
  private int WriteNumberToBuffer(uint value, bool negative)
  {
    ...
    do
    {
      ...
      this._writeBuffer[--num1] = (char) (48U /*0x30*/ + num3);
      value = num2;
    }
    while (value != 0U);
    return buffer;
