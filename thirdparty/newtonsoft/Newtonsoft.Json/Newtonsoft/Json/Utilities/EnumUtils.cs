...
internal static class EnumUtils
{
  ...
  {
    return EnumUtils.TryToString(enumType, value, camelCase ? (NamingStrategy) EnumUtils._camelCaseNamingStrategy : (NamingStrategy) null, out name);
  }
  ...
  {
    return EnumUtils.ValuesAndNamesPerEnum.Get(new StructMultiKey<Type, NamingStrategy>(enumType, (NamingStrategy) null));
  }
