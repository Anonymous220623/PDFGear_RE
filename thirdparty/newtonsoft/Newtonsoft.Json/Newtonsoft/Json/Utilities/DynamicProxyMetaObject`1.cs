...
internal sealed class DynamicProxyMetaObject<T> : DynamicMetaObject
{
  ...
  {
    return !this.IsOverridden("TryGetMember") ? base.BindGetMember(binder) : this.CallMethodWithResult("TryGetMember", (DynamicMetaObjectBinder) binder, (IEnumerable<Expression>) DynamicProxyMetaObject<T>.NoArgs, (DynamicProxyMetaObject<T>.Fallback) (e => binder.FallbackGetMember((DynamicMetaObject) this, e)));
  }
  ...
  {
    return !this.IsOverridden("TryConvert") ? base.BindConvert(binder) : this.CallMethodWithResult("TryConvert", (DynamicMetaObjectBinder) binder, (IEnumerable<Expression>) DynamicProxyMetaObject<T>.NoArgs, (DynamicProxyMetaObject<T>.Fallback) (e => binder.FallbackConvert((DynamicMetaObject) this, e)));
  }
  ...
  {
    return !this.IsOverridden("TryInvoke") ? base.BindInvoke(binder, args) : this.CallMethodWithResult("TryInvoke", (DynamicMetaObjectBinder) binder, (IEnumerable<Expression>) DynamicProxyMetaObject<T>.GetArgArray(args), (DynamicProxyMetaObject<T>.Fallback) (e => binder.FallbackInvoke((DynamicMetaObject) this, args, e)));
  }
  ...
  {
    return !this.IsOverridden("TryUnaryOperation") ? base.BindUnaryOperation(binder) : this.CallMethodWithResult("TryUnaryOperation", (DynamicMetaObjectBinder) binder, (IEnumerable<Expression>) DynamicProxyMetaObject<T>.NoArgs, (DynamicProxyMetaObject<T>.Fallback) (e => binder.FallbackUnaryOperation((DynamicMetaObject) this, e)));
  }
  ...
  {
    return ((IEnumerable<DynamicMetaObject>) args).Select<DynamicMetaObject, Expression>((Func<DynamicMetaObject, Expression>) (arg =>
    {
  ...
  {
    return this.Value != null || !this.HasValue ? BindingRestrictions.GetTypeRestriction(this.Expression, this.LimitType) : BindingRestrictions.GetInstanceRestriction(this.Expression, (object) null);
  }
