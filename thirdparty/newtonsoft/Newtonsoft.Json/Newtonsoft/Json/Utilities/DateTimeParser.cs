...
internal struct DateTimeParser
{
  ...
  private bool ParseTime(ref int start)
  {
    ...
    if (this.ParseChar(start, '.'))
    {
      ...
      {
        int num2 = (int) this._text[start] - 48 /*0x30*/;
        switch (num2)
        {
          case 0:
          case 1:
...
label_7:
  ...
  private bool Parse4Digit(int start, out int num)
  {
    ...
    {
      int num1 = (int) this._text[start] - 48 /*0x30*/;
      int num2 = (int) this._text[start + 1] - 48 /*0x30*/;
      int num3 = (int) this._text[start + 2] - 48 /*0x30*/;
      int num4 = (int) this._text[start + 3] - 48 /*0x30*/;
