...
public sealed class Pix : DisposableBase, IEquatable<Pix>
{
  ...
  {
    IntPtr pix1 = LeptonicaApi.Native.pixBackgroundNormFlex(this.handle, 7, 7, 1, 1, 10);
    IntPtr pix2 = LeptonicaApi.Native.pixGammaTRCMasked(new HandleRef((object) this, IntPtr.Zero), new HandleRef((object) this, pix1), new HandleRef((object) this, IntPtr.Zero), 1f, 100, 175);
    IntPtr binary = LeptonicaApi.Native.pixThresholdToBinary(new HandleRef((object) this, pix2), 180);
    IntPtr fromString = LeptonicaApi.Native.selCreateFromString(selStr, selSize + 2, selSize + 2, "speckle" + selSize.ToString());
    IntPtr pix3 = LeptonicaApi.Native.pixHMT(new HandleRef((object) this, IntPtr.Zero), new HandleRef((object) this, binary), new HandleRef((object) this, fromString));
    IntPtr brick = LeptonicaApi.Native.selCreateBrick(selSize, selSize, 0, 0, SelType.SEL_HIT);
    IntPtr pix4 = LeptonicaApi.Native.pixDilate(new HandleRef((object) this, IntPtr.Zero), new HandleRef((object) this, pix3), new HandleRef((object) this, brick));
    IntPtr handle = LeptonicaApi.Native.pixSubtract(new HandleRef((object) this, IntPtr.Zero), new HandleRef((object) this, binary), new HandleRef((object) this, pix4));
    LeptonicaApi.Native.selDestroy(ref fromString);
    LeptonicaApi.Native.selDestroy(ref brick);
    LeptonicaApi.Native.pixDestroy(ref pix1);
    LeptonicaApi.Native.pixDestroy(ref pix2);
    LeptonicaApi.Native.pixDestroy(ref binary);
    LeptonicaApi.Native.pixDestroy(ref pix3);
    LeptonicaApi.Native.pixDestroy(ref pix4);
    return !(handle == IntPtr.Zero) ? new Pix(handle) : throw new TesseractException("Failed to despeckle image.");
  }
