...
// Type: HandyControl.Controls.HorizontalAlignmentPropertyEditor
...
public class HorizontalAlignmentPropertyEditor : PropertyEditorBase
{
  public override FrameworkElement CreateElement(PropertyItem propertyItem)
  {
    ...
    element.ItemTemplateSelector = HandyControl.Tools.ResourceHelper.GetResourceInternal<DataTemplateSelector>("HorizontalAlignmentPathTemplateSelector");
